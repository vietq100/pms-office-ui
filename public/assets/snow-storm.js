(function () {
  var e = function (e, t) {
    ...
    var n = this, r, i = navigator.userAgent.match(/msie/i), s = navigator.userAgent.match(/msie 6/i),
      o = navigator.userAgent.match(/mobile|opera m(ob|in)/i), u = i && t.compatMode === 'BackCompat', a = u || s,
      f = null, l = null, c = null, h = null, p = null, d = null, v = null, m = 1, g = 2, y = 6, b = false, w = false,
      E = function () {
        try {
        ...
        return true;
      }(), S = false, x = t.createDocumentFragment();
    r = function () {
      function i(t) {
      ...
      var r;
      var s = e.requestAnimationFrame || e.webkitRequestAnimationFrame || e.mozRequestAnimationFrame || e.oRequestAnimationFrame || e.msRequestAnimationFrame || i;
      r = s ? function () {
    ...
    this.events = function () {
      ...
      var t = !e.addEventListener && e.attachEvent, n = Array.prototype.slice,
    ...
    this.resizeHandler = function () {
      if (e.innerWidth || e.innerHeight) {
        ...
        f = (t.documentElement.clientWidth || t.body.clientWidth || t.body.scrollWidth) - (!i ? 8 : 0) - n.flakeRightOffset;
    ...
    this.SnowFlake = function (e, i, s) {
      ...
      this.move = function () {
        ...
        if (t < n.flakeHeight) {
          ...
          if (n.useMeltEffect && o.active && o.type < 3 && !o.melting && Math.random() > .998) {
            o.melting = true;
            o.melt();
          }
      ...
      this.setVelocities = function () {
        o.vX = d + T(n.vMaxX * .12, .1);
        o.vY = v + T(n.vMaxY * .12, .1);
      };
      ...
      this.melt = function () {
        if (!n.useMeltEffect || !o.melting) {
          ...
          if (o.meltFrame < o.meltFrameCount) {
            ...
            o.o.style.lineHeight = n.flakeHeight + 2 + n.flakeHeight * .75 * (o.meltFrame / o.meltFrameCount) + 'px';
            o.meltFrame++;
          } else {
            o.recycle();
          }
