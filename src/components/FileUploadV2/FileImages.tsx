              ...
              <div
                ...
                <div className="ant-upload-list-item-info">
                  <a className="ant-upload-list-item-thumbnail">
                    <img className="ant-upload-list-item-image" src={file.url || file.fileUrl || file.fileThumpUrl} />
                  </a>
                  <a className="ant-upload-list-item-name ant-upload-list-item-name-icon-count-1">{file.name}</a>
                </div>
                {handleRemoveFile && (
