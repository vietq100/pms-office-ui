...
import AppConsts, { AppConfiguration, keySyncfusion } from '@lib/appconst'
import '@syncfusion/ej2-react-richtexteditor/styles/material.css'
    ...
    <div>
      <RichTextEditorComponent
        ...
        value={
          value ||
          '<div><img src="' +
            AppConfiguration.appBaseUrl +
            'assets/images/logo-horizontal.png" style="height:100px" /> <img src="' +
            projectLogo +
            '"style="float:right; height:100px" class="e-rte-image e-imginline"></div><p> </p><div style="text-align:center">-----------------------------------------------------------</div><p> </p><div><br></div><p> </p><div style="text-align:center">&nbsp;</div>'
        }
