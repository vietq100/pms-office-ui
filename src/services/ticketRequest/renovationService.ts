...
class renovationService {
  public async create(body: any) {
    const res = await http.post('api/services/app/RenovationForm/Create', body)
  ...
  public async update(body: any) {
    const res = await http.put('api/services/app/RenovationForm/Update', body)
    notifySuccess(LNotification('SUCCESS'), LNotification('SAVING_SUCCESSFULLY'))
    return TicketRenovationModel.assign(res.data.result)
  }

  public async delete(id: number) {
    const res = await http.delete('api/services/app/RenovationForm/Delete', {
      params: { id }
    })
    return res.data
  }
  ...
  public async get4Staff(id: number): Promise<any> {
    ...
    const res = await http.get('api/services/app/RenovationForm/Get', {
      params: { id }
    })
  ...
  public async get4Resident(id: number): Promise<any> {
    ...
    const res = await http.get('api/services/app/RenovationForm/GetByResident', {
      params: { id }
    })
    const result = TicketRenovationModel.assign(res.data.result)
    return result
  ...
  public async getAll4Staff(params: any): Promise<PagedResultDto<any>> {
    ...
    const res = await http.get('api/services/app/RenovationForm/GetAll', {
      params
    })
  ...
  public async getAll4User(params: any): Promise<PagedResultDto<any>> {
    ...
    const res = await http.get('api/services/app/RenovationForm/GetAllByResident', {
      params
    })
    const { result } = res.data
    result.items = RowTicketRequestModel.assigns(result.items)
  ...
  public async getListZone(params?): Promise<any> {
    const res = await http.get('api/services/app/Zone/GetList', params)
    return res.data.result
  }

  public async getListZoneByUser(): Promise<any> {
    const res = await http.get('api/services/app/Zone/GetListZoneByUser')
    return res.data.result
  }
}
