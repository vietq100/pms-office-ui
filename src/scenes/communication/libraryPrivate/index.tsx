...
import DocumentFolderPrivate from './components/libraryFolder'
...
import LibraryFolderPrivateFormModal from './components/libraryFolderFormModal'
import DocumentFilePrivateFormModal from './components/documentFileFormModal'
import DocumentFilePrivate from './components/documentFile'
...
@observer
class LibrariesPrivate extends AppComponentListBase<ILibrariesProps, ILibrariesState> {
...
export default LibrariesPrivate
