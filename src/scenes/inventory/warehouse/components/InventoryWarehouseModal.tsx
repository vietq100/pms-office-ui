...
export const InventoryWarehouseModal = ({ visible, handleOK, data, handleCancel, onClose }: any) => {
        ...
        <Form
          ...
          <Row gutter={16}>
            <Col md={{ span: 24 }} sm={{ span: 24 }}>
              <Form.Item label={L('INVENTORY_WAREHOUSE_NAME')} {...formItemLayout} name="name" rules={rules.name}>
                <Input onChange={({ target: { value } }) => value} />
              </Form.Item>
            </Col>
            <Col md={{ span: 24 }} sm={{ span: 24 }}>
              <Form.Item label={L('INVENTORY_WAREHOUSE_DESCRIPTION')} {...formItemLayout} name="description">
