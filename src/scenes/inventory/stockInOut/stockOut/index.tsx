...
export enum tabKeys {
  tabStockIn = 'INVENTORY_STOCK_IN',
  tabStockOut = 'INVENTORY_STOCK_OUT'
}
...
@observer
class StockOut extends AppComponentListBase<IInventoryProps, IInventoryState> {
  constructor(props) {
    super(props)
  ...
  getAll = async () => {
    await this.props.inventoryStockInOutStore.getAll(IInventoryStockTypes.stockOut, {
  ...
  handleExportExcel = async () => {
    await this.props.inventoryStockInOutStore.exportExcelStockOut({
      ...this.state.filters
    })
  }
  ...
  renderTabStockOut = () => {
    ...
    const filterStockOut = filter(inventories.items, (_item) => {
    ...
    const filterComponent = (
      <Row gutter={[16, 8]}>
        ...
        <Col sm={{ span: 5, offset: 0 }}>
          ...
          <Select onChange={this.onSelectStatus} style={{ width: '100%' }} value={this.state.filters.isActive}>
    ...
    return (
      <>
        <DataTable
          ...
          title={this.L('INVENTORY_STOCK_OUT_LIST')}
          pagination={{
