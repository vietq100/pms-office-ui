...
const PaymentMethodDetailModal = (props: Props) => {
  ...
  return (
    <Modal
      ...
      okButtonProps={{
        disabled: !isGrantedAny(appPermissions.paymentSetting.update, appPermissions.paymentSetting.create)
      }}
      width={'35%'}>
      <Form form={form} layout="vertical" validateMessages={validateMessages} size="middle">
        <Row gutter={[16, 0]}>
          ...
          <Col sm={{ span: 24, offset: 0 }}>
            <FormSwitch label={L('IS_ACTIVE')} name="isActive" defaultChecked={true} />
          </Col>
        </Row>
      </Form>
    </Modal>
