import { CheckOutlined, EllipsisOutlined, HomeOutlined, UserOutlined } from '@ant-design/icons/lib'
...
export class FeeImportList extends AppComponentBase<Props, any> {
  ...
  columns = [
    ...
    },
    {
      title: () => (
        <>
          {L('FEE_BILL_NUMBER')} <br /> {L('FEE_CUSTOMER')}
        </>
      ),
      width: '20%',
      render: (text, record) => {
        ...
        return (
          <div style={{ color: paymentStatusColor }}>
            <div className="small text-muted">
              ...
              {formatCurrency(record.totalAmount - record.debitAmount)}
            </div>
