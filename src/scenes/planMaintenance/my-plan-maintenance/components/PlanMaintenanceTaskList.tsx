...
@observer
export default class PlanMaintenanceTaskList extends AppComponentListBase<
      ...
      <div className="flex center-items right-content action-menu">
        {this.isGranted(appPermissions.planMaintenance.create) && (
          <React.Fragment>
            ...
            <Button type="primary" size={'small'} shape="circle" onClick={this.toggleModal} className="ml-1">
