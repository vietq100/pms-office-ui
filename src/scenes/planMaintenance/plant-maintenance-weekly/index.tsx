...
export interface IPlanMaintenanceWeeklyProps {
  navigate: any
  params: any
  servicePlanStore: ServicePlanStore
}

export interface IPlanMaintenanceWeeklyState {
...
@observer
class PlanMaintenanceWeekly extends AppComponentListBase<IPlanMaintenanceWeeklyProps, IPlanMaintenanceWeeklyState> {
  state = {
...
export default withRouter(PlanMaintenanceWeekly)
