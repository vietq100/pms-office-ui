...
import { isGrantedAny, LNotification } from '@lib/abpUtility'
...
export default class EditPlanMaintenanceTaskModal extends AppComponentBase<Props, State> {
        ...
        <Form
          ...
          <Row gutter={16}>
            <Col md={{ span: 24 }} sm={{ span: 24 }}>
              <Form.Item name="debitAmount" label={this.L('FEE_EDIT_MODAL_DEBIT_AMOUNT')}>
                <ReactNumeric minimumValue="0" decimalPlaces={0} className="ant-input" />
              </Form.Item>
            </Col>
