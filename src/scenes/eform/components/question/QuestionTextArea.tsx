...
function EFormQuestionTextArea({ formQuestion, viewMode = QUESTION_VIEW_MODE.editQuestion }: EFormQuestionProps) {
  return (
    <Col sm={{ span: 24, offset: 0 }}>
      {viewMode !== QUESTION_VIEW_MODE.viewResponse && (
        <Input.TextArea disabled size="large" className="w-100" placeholder={L('PLEASE_INPUT_A_TEXT')} />
      )}
      {viewMode === QUESTION_VIEW_MODE.viewResponse && (
        <FormTextArea
...
export default EFormQuestionTextArea
