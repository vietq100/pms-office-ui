...
function EFormQuestionMultiChoice({ formQuestion, viewMode = QUESTION_VIEW_MODE.editQuestion }: EFormQuestionProps) {
  return (
...
export default EFormQuestionMultiChoice
