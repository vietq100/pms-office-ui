...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); } /* eslint-disable @typescript-eslint/method-signature-style, @typescript-eslint/unified-signatures */
...
var Form = /*#__PURE__*/function (_React$Component) {
  ...
  function Form(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderForm", function (_ref) {
      ...
      var formClassName = (0, _classnames.default)(prefixCls, _defineProperty(_defineProperty(_defineProperty(_defineProperty({}, "".concat(prefixCls, "-horizontal"), layout === 'horizontal'), "".concat(prefixCls, "-vertical"), layout === 'vertical'), "".concat(prefixCls, "-inline"), layout === 'inline'), "".concat(prefixCls, "-hide-required-mark"), hideRequiredMark), className);
...
FormFC.Item = _FormItem.default;
FormFC.createFormField = _createFormField.default;
FormFC.create = create;
if (process.env.NODE_ENV !== 'production') {
  FormFC.displayName = 'Form';
}
var _default = exports.default = FormFC;