...
function fit(element, viewPortElement = null, axis = { X: false, Y: false }, position) {
    ...
    let zoomingFactor = 1;
    const parentWithZoomStyle = element.closest('[style*="zoom"]');
    ...
    if (axis.X) {
        ...
        const containerLeft = ContainerLeft() / zoomingFactor;
        const containerRight = ContainerRight() / zoomingFactor;
    ...
    if (axis.Y) {
        ...
        const containerTop = ContainerTop() / zoomingFactor;
        const containerBottom = ContainerBottom() / zoomingFactor;
...
let Tooltip = class Tooltip extends Component {
    ...
    getScalingFactor() {
        ...
        const xScalingFactor = (Math.round(eleRect.width) / this.tooltipEle.offsetWidth) || 1;
        const yScalingFactor = (Math.round(eleRect.height) / this.tooltipEle.offsetHeight) || 1;
        return {
    ...
    getTooltipPosition(target) {
        ...
        const scalingFactors = this.getScalingFactor();
