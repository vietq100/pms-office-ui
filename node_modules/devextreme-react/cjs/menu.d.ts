...
declare type IMenuOptionsNarrowedEvents<TKey = any> = {
...
declare type IMenuOptions<TKey = any> = React.PropsWithChildren<ReplaceFieldTypes<Properties<TKey>, IMenuOptionsNarrowedEvents<TKey>> & IHtmlOptions & {
