...
declare type IBoxOptionsNarrowedEvents<TItem = any, TKey = any> = {
...
declare type IBoxOptions<TItem = any, TKey = any> = React.PropsWithChildren<ReplaceFieldTypes<Properties<TItem, TKey>, IBoxOptionsNarrowedEvents<TItem, TKey>> & IHtmlOptions & {
