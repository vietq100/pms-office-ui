import {
  ...
  prepareToken,
  style_default
} from "./chunk-7MY72UDO.js";
import {
  getFieldId,
  getStatus,
  toArray as toArray2,
  useForm
} from "./chunk-XZIV5ZCS.js";
import {
  col_default,
  row_default
} from "./chunk-ZSLRQA4O.js";
import {
  tooltip_default
} from "./chunk-YUTUTQUN.js";
import {
  motion_default
...
var ErrorList = ({
  ...
  const {
    prefixCls
  } = React2.useContext(FormItemPrefixContext);
  const baseClassName = `${prefixCls}-item-explain`;
  const rootCls = useCSSVarCls_default(prefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, rootCls);
  const collapseMotion = React2.useMemo(() => motion_default(prefixCls), [prefixCls]);
  const debounceErrors = useDebounce(errors);
  const debounceWarnings = useDebounce(warnings);
  const fullKeyList = React2.useMemo(() => {
  ...
  const filledKeyFullKeyList = React2.useMemo(() => {
    const keysCount = {};
    fullKeyList.forEach(({
      key
    }) => {
  ...
  return wrapCSSVar(React2.createElement(es_default, {
    ...
    return React2.createElement("div", Object.assign({}, helpProps, {
      className: (0, import_classnames.default)(baseClassName, holderClassName, cssVarCls, rootCls, rootClassName, hashId),
      style: holderStyle
    }), React2.createElement(CSSMotionList_default, Object.assign({
      ...
      return React2.createElement("div", {
        key,
        className: (0, import_classnames.default)(itemClassName, {
...
var FormItemInput = (props) => {
  ...
  const formContext = React6.useContext(FormContext);
  const mergedWrapperCol = React6.useMemo(() => {
  ...
  const className = (0, import_classnames2.default)(`${baseClassName}-control`, mergedWrapperCol.className);
  const subFormContext = React6.useMemo(() => {
    const {
      labelCol: _labelCol,
  ...
  const extraRef = React6.useRef(null);
  const [extraHeight, setExtraHeight] = React6.useState(0);
  useLayoutEffect_default(() => {
  ...
  const inputDom = React6.createElement("div", {
    className: `${baseClassName}-control-input`
  }, React6.createElement("div", {
    className: `${baseClassName}-control-input-content`
  }, children));
  const formItemContext = React6.useMemo(() => ({
    prefixCls,
    status
  }), [prefixCls, status]);
  const errorListDom = marginBottom !== null || errors.length || warnings.length ? React6.createElement(FormItemPrefixContext.Provider, {
    value: formItemContext
  }, React6.createElement(ErrorList_default, {
    fieldId,
    errors,
    warnings,
    help,
  ...
  const extraDom = extra ? React6.createElement("div", Object.assign({}, extraProps, {
    className: `${baseClassName}-extra`,
    ref: extraRef
  }), extra) : null;
  const additionalDom = errorListDom || extraDom ? React6.createElement("div", {
  ...
  const dom = formItemRender && formItemRender.mark === "pro_table_render" && formItemRender.render ? formItemRender.render(props, {
    ...
    extra: extraDom
  }) : React6.createElement(React6.Fragment, null, inputDom, additionalDom);
  return React6.createElement(FormContext.Provider, {
    value: subFormContext
  }, React6.createElement(col_default, Object.assign({}, mergedWrapperCol, {
    className
  }), dom), React6.createElement(fallbackCmp_default, {
    prefixCls
  }));
};
...
function convertToTooltipProps(tooltip) {
  ...
  if (typeof tooltip === "object" && !(0, import_react.isValidElement)(tooltip)) {
    return tooltip;
  }
  return {
    title: tooltip
...
var FormItemLabel = ({
  ...
  const labelColClassName = (0, import_classnames3.default)(labelClsBasic, mergedLabelAlign === "left" && `${labelClsBasic}-left`, mergedLabelCol.className, {
  ...
  if (tooltipProps) {
    const {
      icon = React7.createElement(QuestionCircleOutlined_default, null)
    } = tooltipProps, restTooltipProps = __rest2(tooltipProps, ["icon"]);
    const tooltipNode = React7.createElement(tooltip_default, Object.assign({}, restTooltipProps), React7.cloneElement(icon, {
    ...
    labelChildren = React7.createElement(React7.Fragment, null, labelChildren, tooltipNode);
  }
  ...
  if (isRenderMark) {
    ...
    labelChildren = React7.createElement(React7.Fragment, null, labelChildren, React7.createElement("span", {
  ...
  return React7.createElement(col_default, Object.assign({}, mergedLabelCol, {
...
function StatusProvider({
  ...
  const formItemStatusContext = React8.useMemo(() => {
    var _a;
    let feedbackIcon;
    if (hasFeedback) {
      ...
      feedbackIcon = customIconNode !== false && IconNode ? React8.createElement("span", {
        className: (0, import_classnames4.default)(`${itemPrefixCls}-feedback-icon`, `${itemPrefixCls}-feedback-icon-${mergedValidateStatus}`)
      }, customIconNode || React8.createElement(IconNode, null)) : null;
    }
    const context = {
      status: mergedValidateStatus || "",
      errors,
...
function ItemHolder(props) {
  const {
    ...
    layout: propsLayout,
    name
  } = props, restProps = __rest3(props, ["prefixCls", "className", "rootClassName", "style", "help", "errors", "warnings", "validateStatus", "meta", "hasFeedback", "hidden", "children", "fieldId", "required", "isRequired", "onSubItemMetaChange", "layout", "name"]);
  const itemPrefixCls = `${prefixCls}-item`;
  const {
    requiredMark,
    layout: formLayout
  } = React9.useContext(FormContext);
  ...
  const [marginBottom, setMarginBottom] = React9.useState(null);
  useLayoutEffect_default(() => {
  ...
  const itemClassName = (0, import_classnames5.default)(itemPrefixCls, className, rootClassName, {
  ...
  return React9.createElement("div", {
    ...
    style,
    ref: itemRef
  }, React9.createElement(row_default, Object.assign({
    ...
    "wrapperCol",
    "validateDebounce"
  ])), React9.createElement(FormItemLabel_default, Object.assign({
    htmlFor: fieldId
  }, props, {
    requiredMark,
    ...
    prefixCls,
    vertical
  })), React9.createElement(FormItemInput_default, Object.assign({}, props, meta, {
    ...
    marginBottom,
    onErrorVisibleChanged
  }), React9.createElement(NoStyleItemContext.Provider, {
    value: onSubItemMetaChange
  }, React9.createElement(StatusProvider, {
    prefixCls,
    meta,
    errors: meta.errors,
    ...
    name
  }, children)))), !!marginBottom && React9.createElement("div", {
...
function InternalFormItem(props) {
  ...
  const {
    name: formName
  } = React10.useContext(FormContext);
  const mergedChildren = useChildren(children);
  const isRenderProps = typeof mergedChildren === "function";
  const notifyParentMetaChange = React10.useContext(NoStyleItemContext);
  const {
    validateTrigger: contextValidateTrigger
  } = React10.useContext(FieldContext_default);
  ...
  const listContext = React10.useContext(ListContext_default);
  const fieldKeyPathRef = React10.useRef(null);
  ...
  const [mergedErrors, mergedWarnings] = React10.useMemo(() => {
  ...
  function renderLayout(baseChildren, fieldId, isRequired) {
    if (noStyle && !hidden) {
      return React10.createElement(StatusProvider, {
        prefixCls,
    ...
    return React10.createElement(ItemHolder, Object.assign({
      key: "row"
    }, props, {
      className: (0, import_classnames6.default)(className, cssVarCls, rootCls, hashId),
      prefixCls,
      fieldId,
      isRequired,
      errors: mergedErrors,
  ...
  return wrapCSSVar(React10.createElement(Field_default, Object.assign({}, props, {
    ...
    if (Array.isArray(mergedChildren) && hasName) {
    ...
    } else if (React10.isValidElement(mergedChildren)) {
      ...
      childNode = React10.createElement(MemoInput, {
...
var FormList = (_a) => {
  var {
    prefixCls: customizePrefixCls,
    children
  } = _a, props = __rest4(_a, ["prefixCls", "children"]);
  if (true) {
  ...
  return React11.createElement(List_default, Object.assign({}, props), (fields, operation, meta) => React11.createElement(FormItemPrefixContext.Provider, {
    value: contextValue
...
function useFormInstance() {
  const {
    form
  } = React12.useContext(FormContext);
  return form;
}
...
export {
  convertToTooltipProps_default,
  form_default
};
//# sourceMappingURL=chunk-JOL5RYFS.js.map
