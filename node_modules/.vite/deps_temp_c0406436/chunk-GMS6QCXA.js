...
var import_classnames, React, _excluded, RESIZE_START, RESIZE_MEASURING, RESIZE_STABLE, ResizableTextArea, ResizableTextArea_default;
var init_ResizableTextArea = __esm({
  "node_modules/rc-textarea/es/ResizableTextArea.js"() {
    ...
    _excluded = ["prefixCls", "defaultValue", "value", "autoSize", "onResize", "className", "style", "disabled", "onChange", "onInternalAutoSize"];
    RESIZE_START = 0;
    RESIZE_MEASURING = 1;
    RESIZE_STABLE = 2;
    ResizableTextArea = React.forwardRef(function(props, ref) {
...
var import_classnames2, import_react, _excluded2, TextArea, TextArea_default;
var init_TextArea = __esm({
  "node_modules/rc-textarea/es/TextArea.js"() {
    ...
    _excluded2 = ["defaultValue", "value", "onFocus", "onBlur", "onChange", "allowClear", "maxLength", "onCompositionStart", "onCompositionEnd", "suffix", "prefixCls", "showCount", "count", "className", "style", "disabled", "hidden", "classNames", "styles", "onResize", "onClear", "onPressEnter", "readOnly", "autoSize", "onKeyDown"];
    TextArea = import_react.default.forwardRef(function(_ref, ref) {
      var _countConfig$max;
      var defaultValue = _ref.defaultValue, customValue = _ref.value, onFocus = _ref.onFocus, onBlur = _ref.onBlur, onChange = _ref.onChange, allowClear = _ref.allowClear, maxLength = _ref.maxLength, onCompositionStart = _ref.onCompositionStart, onCompositionEnd = _ref.onCompositionEnd, suffix = _ref.suffix, _ref$prefixCls = _ref.prefixCls, prefixCls = _ref$prefixCls === void 0 ? "rc-textarea" : _ref$prefixCls, showCount = _ref.showCount, count = _ref.count, className = _ref.className, style = _ref.style, disabled = _ref.disabled, hidden = _ref.hidden, classNames2 = _ref.classNames, styles = _ref.styles, onResize = _ref.onResize, onClear = _ref.onClear, onPressEnter = _ref.onPressEnter, readOnly = _ref.readOnly, autoSize = _ref.autoSize, onKeyDown = _ref.onKeyDown, rest = _objectWithoutProperties(_ref, _excluded2);
      var _useMergedState = useMergedState(defaultValue, {
        value: customValue,
        defaultValue
      ...
      if (countConfig.show) {
        ...
        suffixNode = import_react.default.createElement(import_react.default.Fragment, null, suffixNode, import_react.default.createElement("span", {
          className: (0, import_classnames2.default)("".concat(prefixCls, "-data-count"), classNames2 === null || classNames2 === void 0 ? void 0 : classNames2.count),
      ...
      return import_react.default.createElement(BaseInput_default, {
        ...
        classNames: _objectSpread2(_objectSpread2({}, classNames2), {}, {
          affixWrapper: (0, import_classnames2.default)(classNames2 === null || classNames2 === void 0 ? void 0 : classNames2.affixWrapper, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-show-count"), showCount), "".concat(prefixCls, "-textarea-allow-clear"), allowClear))
        }),
        disabled,
        focused,
        ...
        className: (0, import_classnames2.default)(classNames2 === null || classNames2 === void 0 ? void 0 : classNames2.textarea),
...
//# sourceMappingURL=chunk-GMS6QCXA.js.map
