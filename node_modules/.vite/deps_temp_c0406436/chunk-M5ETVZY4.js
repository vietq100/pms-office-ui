...
function Star(props, ref) {
  ...
  var start = import_react.default.createElement("li", {
    className: (0, import_classnames.default)(Array.from(classNameList)),
    ref
  ...
  }, characterNode), import_react.default.createElement("div", {
...
var import_react, import_classnames, Star_default;
var init_Star = __esm({
  "node_modules/rc-rate/es/Star.js"() {
    import_react = __toESM(require_react());
    init_KeyCode();
    import_classnames = __toESM(require_classnames());
    Star_default = import_react.default.forwardRef(Star);
  }
});
...
function Rate(props, ref) {
  ...
  var rateRef = import_react2.default.useRef(null);
  ...
  import_react2.default.useImperativeHandle(ref, function() {
    return {
      focus: triggerFocus,
      blur: function blur() {
        if (!disabled) {
  ...
  var _React$useState = import_react2.default.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), focused = _React$useState2[0], setFocused = _React$useState2[1];
  ...
  var _React$useState3 = import_react2.default.useState(null), _React$useState4 = _slicedToArray(_React$useState3, 2), hoverValue = _React$useState4[0], setHoverValue = _React$useState4[1];
  ...
  var starNodes = new Array(count).fill(0).map(function(item, index) {
    return import_react2.default.createElement(Star_default, {
  ...
  var classString = (0, import_classnames2.default)(prefixCls, className, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-disabled"), disabled), "".concat(prefixCls, "-rtl"), direction === "rtl"));
  return import_react2.default.createElement("ul", _extends({
...
var import_classnames2, import_react2, _excluded, Rate_default;
var init_Rate = __esm({
  "node_modules/rc-rate/es/Rate.js"() {
    init_extends();
    init_defineProperty();
    ...
    init_useRefs();
    init_util();
    _excluded = ["prefixCls", "className", "defaultValue", "value", "count", "allowHalf", "allowClear", "keyboard", "character", "characterRender", "disabled", "direction", "tabIndex", "autoFocus", "onHoverChange", "onChange", "onFocus", "onBlur", "onKeyDown", "onMouseLeave"];
    Rate_default = import_react2.default.forwardRef(Rate);
  }
});
...
//# sourceMappingURL=chunk-M5ETVZY4.js.map
