...
var CheckableTag = React.forwardRef((props, ref) => {
  ...
  const cls = (0, import_classnames.default)(prefixCls, `${prefixCls}-checkable`, {
...
var InternalTag = React2.forwardRef((tagProps, ref) => {
  const {
    prefixCls: customizePrefixCls,
    className,
    rootClassName,
  ...
  } = tagProps, props = __rest2(tagProps, ["prefixCls", "className", "rootClassName", "style", "children", "icon", "color", "onClose", "bordered", "visible"]);
  const {
    getPrefixCls,
    direction,
    tag: tagContext
  ...
  const prefixCls = getPrefixCls("tag", customizePrefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls);
  const tagClassName = (0, import_classnames2.default)(prefixCls, tagContext === null || tagContext === void 0 ? void 0 : tagContext.className, {
  ...
  const [, mergedCloseIcon] = useClosable(pickClosable(tagProps), pickClosable(tagContext), {
    ...
    closeIconRender: (iconNode2) => {
      const replacement = React2.createElement("span", {
      ...
      return replaceElement(iconNode2, replacement, (originProps) => ({
        ...
        className: (0, import_classnames2.default)(originProps === null || originProps === void 0 ? void 0 : originProps.className, `${prefixCls}-close-icon`)
      }));
    }
  });
  const isNeedWave = typeof props.onClick === "function" || children && children.type === "a";
  const iconNode = icon || null;
  const kids = iconNode ? React2.createElement(React2.Fragment, null, iconNode, children && React2.createElement("span", null, children)) : children;
  const tagNode = React2.createElement("span", Object.assign({}, domProps, {
    ref,
    className: tagClassName,
    style: tagStyle
  }), kids, mergedCloseIcon, isPreset && React2.createElement(presetCmp_default, {
    key: "preset",
    prefixCls
  }), isStatus && React2.createElement(statusCmp_default, {
    key: "status",
    prefixCls
  }));
  return wrapCSSVar(isNeedWave ? React2.createElement(wave_default, {
    component: "Tag"
  }, tagNode) : tagNode);
});
var Tag = InternalTag;
...
//# sourceMappingURL=chunk-CO2SUZUL.js.map
