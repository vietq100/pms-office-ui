...
import {
  tabs_default
} from "./chunk-OI5V2ZY3.js";
import {
  useVariants_default
} from "./chunk-AANE3R3C.js";
import {
  useSize_default
...
var Grid = (_a) => {
  var {
    ...
    className,
    hoverable = true
  } = _a, props = __rest(_a, ["prefixCls", "className", "hoverable"]);
  const {
    getPrefixCls
  } = React.useContext(ConfigContext);
  const prefix = getPrefixCls("card", prefixCls);
  const classString = (0, import_classnames.default)(`${prefix}-grid`, className, {
...
var ActionNode = (props) => {
  ...
  return React2.createElement("ul", {
    ...
    return React2.createElement("li", {
      ...
      key
    }, React2.createElement("span", null, action));
  }));
};
var Card = React2.forwardRef((props, ref) => {
  const {
    ...
    styles: customStyles
  } = props, others = __rest2(props, ["prefixCls", "className", "rootClassName", "style", "extra", "headStyle", "bodyStyle", "title", "loading", "bordered", "variant", "size", "type", "cover", "actions", "tabList", "children", "activeTabKey", "defaultActiveTabKey", "tabBarExtraContent", "hoverable", "tabProps", "classNames", "styles"]);
  const {
    getPrefixCls,
    direction,
    card
  ...
  const moduleClass = (moduleName) => {
    var _a;
    return (0, import_classnames2.default)((_a = card === null || card === void 0 ? void 0 : card.classNames) === null || _a === void 0 ? void 0 : _a[moduleName], customClassNames === null || customClassNames === void 0 ? void 0 : customClassNames[moduleName]);
  };
  ...
  const isContainGrid = React2.useMemo(() => {
  ...
  const loadingBlock = React2.createElement(skeleton_default, {
    loading: true,
    active: true,
    paragraph: {
      rows: 4
  ...
  const tabs = tabList ? React2.createElement(tabs_default, Object.assign({
    size: tabSize
  }, extraProps, {
  ...
  if (title || extra || tabs) {
    const headClasses = (0, import_classnames2.default)(`${prefixCls}-head`, moduleClass("header"));
    const titleClasses = (0, import_classnames2.default)(`${prefixCls}-head-title`, moduleClass("title"));
    const extraClasses = (0, import_classnames2.default)(`${prefixCls}-extra`, moduleClass("extra"));
    const mergedHeadStyle = Object.assign(Object.assign({}, headStyle), moduleStyle("header"));
    head = React2.createElement("div", {
      className: headClasses,
      style: mergedHeadStyle
    }, React2.createElement("div", {
      className: `${prefixCls}-head-wrapper`
    }, title && React2.createElement("div", {
      className: titleClasses,
      style: moduleStyle("title")
    }, title), extra && React2.createElement("div", {
      className: extraClasses,
      style: moduleStyle("extra")
    }, extra)), tabs);
  }
  const coverClasses = (0, import_classnames2.default)(`${prefixCls}-cover`, moduleClass("cover"));
  const coverDom = cover ? React2.createElement("div", {
    className: coverClasses,
    style: moduleStyle("cover")
  }, cover) : null;
  const bodyClasses = (0, import_classnames2.default)(`${prefixCls}-body`, moduleClass("body"));
  const mergedBodyStyle = Object.assign(Object.assign({}, bodyStyle), moduleStyle("body"));
  const body = React2.createElement("div", {
    className: bodyClasses,
    style: mergedBodyStyle
  }, loading ? loadingBlock : children);
  const actionClasses = (0, import_classnames2.default)(`${prefixCls}-actions`, moduleClass("actions"));
  const actionDom = (actions === null || actions === void 0 ? void 0 : actions.length) ? React2.createElement(ActionNode, {
    actionClasses,
    actionStyle: moduleStyle("actions"),
    actions
  }) : null;
  const divProps = omit(others, ["onTabChange"]);
  const classString = (0, import_classnames2.default)(prefixCls, card === null || card === void 0 ? void 0 : card.className, {
...
var Meta = (props) => {
  const {
    ...
    title,
    description
  } = props, others = __rest3(props, ["prefixCls", "className", "avatar", "title", "description"]);
  const {
    getPrefixCls
  } = React3.useContext(ConfigContext);
  const prefixCls = getPrefixCls("card", customizePrefixCls);
  const classString = (0, import_classnames3.default)(`${prefixCls}-meta`, className);
  const avatarDom = avatar ? React3.createElement("div", {
    className: `${prefixCls}-meta-avatar`
  }, avatar) : null;
  const titleDom = title ? React3.createElement("div", {
    className: `${prefixCls}-meta-title`
  }, title) : null;
  const descriptionDom = description ? React3.createElement("div", {
    className: `${prefixCls}-meta-description`
  }, description) : null;
  const MetaDetail = titleDom || descriptionDom ? React3.createElement("div", {
    className: `${prefixCls}-meta-detail`
  }, titleDom, descriptionDom) : null;
  return React3.createElement("div", Object.assign({}, others, {
    className: classString
...
//# sourceMappingURL=chunk-ST3RHHQX.js.map
