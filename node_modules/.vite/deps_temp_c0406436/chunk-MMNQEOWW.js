...
var WaveEffect = (props) => {
  ...
  const unmountRef = React2.useRef(null);
  React2.useEffect(() => {
...
var showWaveEffect = (target, info) => {
  ...
  unmountCallback = reactRender2(React2.createElement(WaveEffect, Object.assign({}, info, {
    target,
    registerUnmount
  })), holder);
};
...
//# sourceMappingURL=chunk-MMNQEOWW.js.map
