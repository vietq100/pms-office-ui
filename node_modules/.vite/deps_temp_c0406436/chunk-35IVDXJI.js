...
var useClosable = (propCloseCollection, contextCloseCollection, fallbackCloseCollection = EmptyFallbackCloseCollection) => {
  ...
  const mergedFallbackCloseCollection = import_react.default.useMemo(() => Object.assign({
    closeIcon: import_react.default.createElement(CloseOutlined_default, null)
  }, fallbackCloseCollection), [fallbackCloseCollection]);
  const mergedClosableConfig = import_react.default.useMemo(() => {
  ...
  return import_react.default.useMemo(() => {
    ...
    if (mergedCloseIcon !== null && mergedCloseIcon !== void 0) {
      ...
      mergedCloseIcon = import_react.default.isValidElement(mergedCloseIcon) ? import_react.default.cloneElement(mergedCloseIcon, Object.assign(Object.assign(Object.assign({}, mergedCloseIcon.props), {
        "aria-label": (_b = (_a = mergedCloseIcon.props) === null || _a === void 0 ? void 0 : _a["aria-label"]) !== null && _b !== void 0 ? _b : contextLocale.close
      }), ariaOrDataProps)) : import_react.default.createElement("span", Object.assign({
...
var useForceUpdate = () => {
  return import_react4.default.useReducer((ori) => ori + 1, 0);
};
    ...
    Object.keys(cur || {}).forEach((key) => {
      ...
      if (keySchema && typeof keySchema === "object") {
        if (curVal && typeof curVal === "object") {
          ...
          if (defaultField) {
            acc[key] = acc[key] || {};
            acc[key][defaultField] = (0, import_classnames.default)(acc[key][defaultField], curVal);
          }
        }
      } else {
        acc[key] = (0, import_classnames.default)(acc[key], curVal);
      }
    });
    return acc;
  }, {});
...
function useSemanticClassNames(schema, ...classNames) {
  return React5.useMemo(() => mergeClassNames.apply(void 0, [schema].concat(classNames)), [classNames, schema]);
}
...
var useMultipleSelect = (getKey) => {
  const [prevSelectedIndex, setPrevSelectedIndex] = (0, import_react5.useState)(null);
  const multipleSelect = (0, import_react5.useCallback)((currentSelectedIndex, data, selectedKeys) => {
...
var usePatchElement = () => {
  const [elements, setElements] = React6.useState([]);
  const patchElement = React6.useCallback((element) => {
...
var useSyncState = (initialValue) => {
  const ref = React7.useRef(initialValue);
...
//# sourceMappingURL=chunk-35IVDXJI.js.map
