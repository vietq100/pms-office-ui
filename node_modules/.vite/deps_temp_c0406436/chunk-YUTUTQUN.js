...
var PurePanel = (props) => {
  ...
  const cls = (0, import_classnames2.default)(hashId, cssVarCls, prefixCls, `${prefixCls}-pure`, `${prefixCls}-placement-${placement}`, className, colorInfo.className);
...
var InternalTooltip = React2.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const tooltipPlacements = React2.useMemo(() => {
    var _a2, _b2;
  ...
  const memoOverlay = React2.useMemo(() => {
    if (title === 0) {
      return title;
    }
    return overlay || title || "";
  }, [overlay, title]);
  const memoOverlayWrapper = React2.createElement(ContextIsolator_default, {
    space: true
  ...
  const child = React2.isValidElement(children) && !isFragment(children) ? children : React2.createElement("span", null, children);
  const childProps = child.props;
  const childCls = !childProps.className || typeof childProps.className === "string" ? (0, import_classnames3.default)(childProps.className, openClassName || `${prefixCls}-open`) : childProps.className;
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, !injectFromPopover);
  const colorInfo = parseColor(prefixCls, color);
  const arrowContentStyle = colorInfo.arrowStyle;
  const rootClassNames = (0, import_classnames3.default)(overlayClassName, {
  ...
  const bodyClassNames = (0, import_classnames3.default)(contextClassNames.body, tooltipClassNames === null || tooltipClassNames === void 0 ? void 0 : tooltipClassNames.body);
  const [zIndex, contextZIndex] = useZIndex("Tooltip", restProps.zIndex);
  const content = React2.createElement(es_default, Object.assign({}, restProps, {
    zIndex,
    ...
    arrowContent: React2.createElement("span", {
  ...
  return wrapCSSVar(React2.createElement(zindexContext_default.Provider, {
    value: contextZIndex
  }, content));
});
...
Tooltip._InternalPanelDoNotUseOrYouWillBeFired = PurePanel_default;
...
//# sourceMappingURL=chunk-YUTUTQUN.js.map
