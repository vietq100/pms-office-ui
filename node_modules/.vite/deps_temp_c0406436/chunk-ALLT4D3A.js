...
var CustomCircle = (props) => {
  ...
  return React.createElement("circle", {
    className: (0, import_classnames.default)(`${dotClassName}-circle`, {
...
var Progress = ({
  ...
  return React.createElement("span", {
    className: (0, import_classnames.default)(holderClassName, `${dotClassName}-progress`, safePtg <= 0 && hideClassName)
  ...
  }, React.createElement(CustomCircle, {
    dotClassName,
    hasCircleCls: true
  }), React.createElement(CustomCircle, {
    dotClassName,
...
function Looper(props) {
  ...
  const holderClassName = `${dotClassName}-holder`;
  const hideClassName = `${holderClassName}-hidden`;
  return React2.createElement(React2.Fragment, null, React2.createElement("span", {
    className: (0, import_classnames2.default)(holderClassName, percent > 0 && hideClassName)
  }, React2.createElement("span", {
    className: (0, import_classnames2.default)(dotClassName, `${prefixCls}-dot-spin`)
  }, [1, 2, 3, 4].map((i) => React2.createElement("i", {
    className: `${prefixCls}-dot-item`,
    key: i
  })))), React2.createElement(Progress_default, {
    prefixCls,
    percent
  }));
}
...
function Indicator(props) {
  ...
  const dotClassName = `${prefixCls}-dot`;
  if (indicator && React3.isValidElement(indicator)) {
    return cloneElement(indicator, {
      className: (0, import_classnames3.default)((_a = indicator.props) === null || _a === void 0 ? void 0 : _a.className, dotClassName),
      percent
    });
  }
  return React3.createElement(Looper, {
    prefixCls,
    percent
  });
}
...
function usePercent(spinning, percent) {
  const [mockPercent, setMockPercent] = React4.useState(0);
  const mockIntervalRef = React4.useRef(null);
...
var Spin = (props) => {
  ...
  const [spinning, setSpinning] = React5.useState(() => customSpinning && !shouldDelay(customSpinning, delay));
  ...
  const isNestedPattern = React5.useMemo(() => typeof children !== "undefined" && !fullscreen, [children, fullscreen]);
  if (true) {
    const warning = devUseWarning("Spin");
    true ? warning(!tip || isNestedPattern || fullscreen, "usage", "`tip` only work in nest or fullscreen pattern.") : void 0;
  }
  const spinClassName = (0, import_classnames4.default)(prefixCls, contextClassName, {
  ...
  const containerClassName = (0, import_classnames4.default)(`${prefixCls}-container`, {
  ...
  const spinElement = React5.createElement("div", Object.assign({}, restProps, {
    style: mergedStyle,
  ...
  }), tip && (isNestedPattern || fullscreen) ? React5.createElement("div", {
    className: `${prefixCls}-text`
  }, tip) : null);
  if (isNestedPattern) {
    return wrapCSSVar(React5.createElement("div", Object.assign({}, restProps, {
      className: (0, import_classnames4.default)(`${prefixCls}-nested-loading`, wrapperClassName, hashId, cssVarCls)
    }), spinning && React5.createElement("div", {
      key: "loading"
    }, spinElement), React5.createElement("div", {
  ...
  if (fullscreen) {
    return wrapCSSVar(React5.createElement("div", {
      className: (0, import_classnames4.default)(`${prefixCls}-fullscreen`, {
...
//# sourceMappingURL=chunk-ALLT4D3A.js.map
