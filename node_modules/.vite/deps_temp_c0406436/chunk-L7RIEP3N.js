import {
  ...
  es_default,
  init_es as init_es2
} from "./chunk-HNGGFIFP.js";
import {
  canUseDocElement
} from "./chunk-KJ6Y3CHV.js";
import {
  skeleton_default
} from "./chunk-3NN2BMNW.js";
import {
  withPureRenderTheme
} from "./chunk-B37BYMCW.js";
import {
  getMediaSize
} from "./chunk-PWYXABD2.js";
import {
  button_default,
  convertLegacyProps
} from "./chunk-PCSHPGYG.js";
import {
...
} from "./chunk-35IVDXJI.js";
import {
  ContextIsolator_default
} from "./chunk-6VNPR64B.js";
import {
  getTransitionName
} from "./chunk-TJAJNUHO.js";
import {
  initFadeMotion,
  initZoomMotion
} from "./chunk-RB23474D.js";
import {
  unstableSetRender
} from "./chunk-MMNQEOWW.js";
import {
  useCSSVarCls_default
} from "./chunk-LG4NX6BF.js";
import {
...
} from "./chunk-5ZOJYOGY.js";
import {
  ExclamationCircleFilled_default
} from "./chunk-DBZSUXJO.js";
import {
  CheckCircleFilled_default
} from "./chunk-KJ5SK7RZ.js";
import {
  CloseCircleFilled_default
} from "./chunk-PII3C4HS.js";
import {
  CloseOutlined_default
} from "./chunk-2WHAXEY4.js";
import {
  composeRef,
  init_ref
...
var ModalContext = import_react.default.createContext({});
var {
...
var ConfirmCancelBtn = () => {
  const {
    ...
    onCancel,
    onConfirm
  } = (0, import_react2.useContext)(ModalContext);
  return mergedOkCancel ? import_react2.default.createElement(ActionButton_default, {
    isSilent,
    actionFn: onCancel,
    close: (...args) => {
      close === null || close === void 0 ? void 0 : close.apply(void 0, args);
...
var ConfirmOkBtn = () => {
  ...
  return import_react3.default.createElement(ActionButton_default, {
    isSilent,
    type: okType || "primary",
    actionFn: onOk,
    close: (...args) => {
...
var WatermarkContext = React5.createContext({
  add: voidFunc,
  remove: voidFunc
});
function usePanelRef(panelSelector) {
  const watermark = React5.useContext(WatermarkContext);
  const panelEleRef = React5.useRef(null);
...
var NormalCancelBtn = () => {
  ...
  return import_react4.default.createElement(button_default, Object.assign({
    onClick: onCancel
...
var NormalOkBtn = () => {
  ...
  return import_react5.default.createElement(button_default, Object.assign({}, convertLegacyProps(okType), {
...
function renderCloseIcon(prefixCls, closeIcon) {
  ...
  }, closeIcon || import_react6.default.createElement(CloseOutlined_default, {
...
var Footer = (props) => {
  ...
  const memoizedValue = import_react6.default.useMemo(() => {
    return {
      confirmLoading,
      okButtonProps,
      cancelButtonProps,
  ...
  if (typeof footer === "function" || typeof footer === "undefined") {
    footerNode = import_react6.default.createElement(import_react6.default.Fragment, null, import_react6.default.createElement(NormalCancelBtn_default, null), import_react6.default.createElement(NormalOkBtn_default, null));
    ...
    footerNode = import_react6.default.createElement(ModalContextProvider, {
      value: memoizedValue
    }, footerNode);
  } else {
    footerNode = footer;
  }
  return import_react6.default.createElement(DisabledContextProvider, {
    disabled: false
  }, footerNode);
};
...
var style_default = genStyleHooks("Modal", (token) => {
...
var Modal = (props) => {
  const {
    ...
    panelRef = null,
    modalRender
  } = props, restProps = __rest(props, ["prefixCls", "className", "rootClassName", "open", "wrapClassName", "centered", "getContainer", "focusTriggerAfterClose", "style", "visible", "width", "footer", "classNames", "styles", "children", "loading", "confirmLoading", "zIndex", "mousePosition", "onOk", "onCancel", "destroyOnHidden", "destroyOnClose", "panelRef", "modalRender"]);
  const {
  ...
  const wrapClassNameExtended = (0, import_classnames.default)(wrapClassName, {
  ...
  const dialogFooter = footer !== null && !loading ? React9.createElement(Footer, Object.assign({}, props, {
    onOk: handleOk,
  ...
  const mergedModalRender = modalRender ? (node) => React9.createElement("div", {
  ...
  const [numWidth, responsiveWidth] = React9.useMemo(() => {
    if (width && typeof width === "object") {
      return [void 0, width];
    }
    return [width, void 0];
  }, [width]);
  const responsiveWidthVars = React9.useMemo(() => {
    const vars = {};
    if (responsiveWidth) {
  ...
  return wrapCSSVar(React9.createElement(ContextIsolator_default, {
    form: true,
    space: true
  }, React9.createElement(zindexContext_default.Provider, {
    value: contextZIndex
  }, React9.createElement(es_default, Object.assign({
    width: numWidth
  }, restProps, {
    zIndex,
    getContainer: getContainer === void 0 ? getContextPopupContainer : getContainer,
    prefixCls,
    rootClassName: (0, import_classnames.default)(hashId, rootClassName, cssVarCls, rootCls),
    footer: dialogFooter,
    ...
    className: (0, import_classnames.default)(hashId, className, modalContext === null || modalContext === void 0 ? void 0 : modalContext.className),
    ...
    classNames: Object.assign(Object.assign(Object.assign({}, modalContext === null || modalContext === void 0 ? void 0 : modalContext.classNames), modalClassNames), {
      wrapper: (0, import_classnames.default)(wrapClassNameExtended, modalClassNames === null || modalClassNames === void 0 ? void 0 : modalClassNames.wrapper)
    }),
  ...
  }), loading ? React9.createElement(skeleton_default, {
    active: true,
    title: false,
    paragraph: {
      rows: 4
...
var ConfirmContent = (props) => {
  const {
    ...
    locale: staticLocale
  } = props, resetProps = __rest2(props, ["prefixCls", "icon", "okText", "cancelText", "confirmPrefixCls", "type", "okCancel", "footer", "locale"]);
  if (true) {
    const warning = devUseWarning("Modal");
  ...
  if (!icon && icon !== null) {
    switch (type) {
      case "info":
        mergedIcon = React10.createElement(InfoCircleFilled_default, null);
        break;
      case "success":
        mergedIcon = React10.createElement(CheckCircleFilled_default, null);
        break;
      case "error":
        mergedIcon = React10.createElement(CloseCircleFilled_default, null);
        break;
      default:
        mergedIcon = React10.createElement(ExclamationCircleFilled_default, null);
    }
  }
  ...
  const memoizedValue = React10.useMemo(() => {
  ...
  const footerOriginNode = React10.createElement(React10.Fragment, null, React10.createElement(ConfirmCancelBtn_default, null), React10.createElement(ConfirmOkBtn_default, null));
  ...
  return React10.createElement("div", {
    ...
    className: (0, import_classnames2.default)(bodyCls, {
      [`${bodyCls}-has-title`]: hasTitle
    })
  }, mergedIcon, React10.createElement("div", {
    className: `${confirmPrefixCls}-paragraph`
  }, hasTitle && React10.createElement("span", {
    className: `${confirmPrefixCls}-title`
  }, props.title), React10.createElement("div", {
    className: `${confirmPrefixCls}-content`
  }, props.content))), footer === void 0 || typeof footer === "function" ? React10.createElement(ModalContextProvider, {
    value: memoizedValue
  }, React10.createElement("div", {
  ...
  }) : footerOriginNode)) : footer, React10.createElement(confirm_default, {
    prefixCls
  }));
};
var ConfirmDialog = (props) => {
  ...
  const classString = (0, import_classnames2.default)(confirmPrefixCls, `${confirmPrefixCls}-${props.type}`, {
    [`${confirmPrefixCls}-rtl`]: direction === "rtl"
  }, props.className);
  const [, token] = useToken();
  const mergedZIndex = React10.useMemo(() => {
    if (zIndex !== void 0) {
      return zIndex;
    }
    return token.zIndexPopupBase + CONTAINER_MAX_OFFSET;
  }, [zIndex, token]);
  return React10.createElement(Modal_default, Object.assign({}, props, {
    className: classString,
    wrapClassName: (0, import_classnames2.default)({
    ...
    zIndex: mergedZIndex,
    closable
  }), React10.createElement(ConfirmContent, Object.assign({}, props, {
    confirmPrefixCls
  })));
};
var ConfirmDialogWrapper = (props) => {
  ...
  return React10.createElement(config_provider_default, {
    prefixCls: rootPrefixCls,
    iconPrefixCls,
    direction,
    theme
  }, React10.createElement(ConfirmDialog, Object.assign({}, props)));
};
if (true) {
...
var ConfirmDialogWrapper2 = (props) => {
  ...
  const config = (0, import_react7.useContext)(ConfigContext);
  ...
  return import_react7.default.createElement(ConfirmDialog_default, Object.assign({}, props, {
    rootPrefixCls,
    prefixCls,
...
function confirm(config) {
  ...
  const scheduleRender = (props) => {
    ...
    timeoutId = setTimeout(() => {
      ...
      const dom = import_react7.default.createElement(ConfirmDialogWrapper2, Object.assign({}, props));
      const reactRender = unstableSetRender();
      reactUnmount = reactRender(import_react7.default.createElement(config_provider_default, {
        prefixCls: rootPrefixCls,
        iconPrefixCls,
        theme
...
var PurePanel = (props) => {
  const {
    ...
    children,
    footer
  } = props, restProps = __rest3(props, ["prefixCls", "className", "closeIcon", "closable", "type", "title", "children", "footer"]);
  const {
    getPrefixCls
  ...
  if (type) {
    additionalProps = {
      ...
      title: "",
      footer: "",
      children: React12.createElement(ConfirmContent, Object.assign({}, props, {
        prefixCls,
        confirmPrefixCls,
        rootPrefixCls,
        content: children
    ...
    additionalProps = {
      ...
      title,
      footer: footer !== null && React12.createElement(Footer, Object.assign({}, props)),
      children
    };
  }
  return wrapCSSVar(React12.createElement(Panel_default, Object.assign({
    prefixCls,
    className: (0, import_classnames3.default)(hashId, `${prefixCls}-pure-panel`, type && confirmPrefixCls, type && `${confirmPrefixCls}-${type}`, className, cssVarCls, rootCls)
  }, restProps, {
...
var HookModal = (_a, ref) => {
  ...
  var {
    ...
    config
  } = _a, restProps = __rest4(_a, ["afterClose", "config"]);
  const [open, setOpen] = React13.useState(true);
  const [innerConfig, setInnerConfig] = React13.useState(config);
  const {
    direction,
    getPrefixCls
  ...
  return React13.createElement(ConfirmDialog_default, Object.assign({
    prefixCls,
    rootPrefixCls
  }, innerConfig, {
    close,
...
var HookModal_default = React13.forwardRef(HookModal);

// node_modules/antd/es/modal/useModal/index.js
var uuid = 0;
var ElementsHolder = React14.memo(React14.forwardRef((_props, ref) => {
  const [elements, patchElement] = usePatchElement();
  React14.useImperativeHandle(ref, () => ({
    patchElement
  }), [patchElement]);
  return React14.createElement(React14.Fragment, null, elements);
}));
function useModal() {
  const holderRef = React14.useRef(null);
  const [actionQueue, setActionQueue] = React14.useState([]);
  React14.useEffect(() => {
  ...
  const getConfirmFunc = React14.useCallback((withFunc) => function hookConfirm(config) {
    var _a;
    uuid += 1;
    const modalRef = React14.createRef();
    let resolvePromise;
    ...
    let silent = false;
    let closeFunc;
    const modal = React14.createElement(HookModal_default, {
      key: `modal-${uuid}`,
  ...
  return [fns, React14.createElement(ElementsHolder, {
    key: "modal-holder",
    ref: holderRef
  })];
}
...
//# sourceMappingURL=chunk-L7RIEP3N.js.map
