...
var style_default = genStyleHooks("Form", (token, {
  rootPrefixCls
}) => {
...
var InternalForm = (props, ref) => {
  ...
  const mergedRequiredMark = React2.useMemo(() => {
  ...
  const formContextValue = React2.useMemo(() => ({
    name,
    labelAlign,
    labelCol,
    labelWrap,
  ...
  }, React2.createElement(NoFormStyle, {
    status: true
...
//# sourceMappingURL=chunk-7MY72UDO.js.map
