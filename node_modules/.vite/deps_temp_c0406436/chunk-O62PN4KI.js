...
var GroupContext = import_react.default.createContext(null);
...
var style_default = genStyleHooks("Checkbox", (token, {
  prefixCls
...
function useBubbleLock(onOriginInputClick) {
  const labelClickLockRef = import_react2.default.useRef(null);
  const clearLock = () => {
...
var InternalCheckbox = (props, ref) => {
  ...
  const checkboxGroup = React3.useContext(GroupContext_default);
  const {
    isFormItemInput
  ...
  const prevValue = React3.useRef(restProps.value);
  const checkboxRef = React3.useRef(null);
  const mergedRef = composeRef(ref, checkboxRef);
  if (true) {
    const warning = devUseWarning("Checkbox");
    true ? warning("checked" in restProps || !!checkboxGroup || !("value" in restProps), "usage", "`value` is not a valid prop, do you mean `checked`?") : void 0;
  }
  React3.useEffect(() => {
  ...
  const classString = (0, import_classnames.default)(`${prefixCls}-wrapper`, {
    [`${prefixCls}-rtl`]: direction === "rtl",
    [`${prefixCls}-wrapper-checked`]: checkboxProps.checked,
    [`${prefixCls}-wrapper-disabled`]: mergedDisabled,
    [`${prefixCls}-wrapper-in-form-item`]: isFormItemInput
  }, checkbox === null || checkbox === void 0 ? void 0 : checkbox.className, className, rootClassName, cssVarCls, rootCls, hashId);
  const checkboxClass = (0, import_classnames.default)({
  ...
  }, React3.createElement(es_default, Object.assign({}, checkboxProps, {
    onClick: onInputClick,
    prefixCls,
    className: checkboxClass,
    disabled: mergedDisabled,
    ref: mergedRef
  })), children !== void 0 && children !== null && React3.createElement("span", {
    className: `${prefixCls}-label`
  }, children))));
};
var Checkbox = React3.forwardRef(InternalCheckbox);
if (true) {
...
var CheckboxGroup = React4.forwardRef((props, ref) => {
  const {
    defaultValue,
    children,
    options = [],
  ...
  const [value, setValue] = React4.useState(restProps.value || defaultValue || []);
  const [registeredValues, setRegisteredValues] = React4.useState([]);
  React4.useEffect(() => {
    if ("value" in restProps) {
      setValue(restProps.value || []);
    }
  }, [restProps.value]);
  const memoizedOptions = React4.useMemo(() => options.map((option) => {
  ...
  const childrenNode = options.length ? memoizedOptions.map((option) => React4.createElement(Checkbox_default, {
    prefixCls,
    ...
    className: (0, import_classnames2.default)(`${groupPrefixCls}-item`, option.className),
    style: option.style,
    title: option.title,
    id: option.id,
    required: option.required
  }, option.label)) : children;
  const memoizedContext = React4.useMemo(() => ({
    toggleOption,
    value,
  ...
  const classString = (0, import_classnames2.default)(groupPrefixCls, {
    [`${groupPrefixCls}-rtl`]: direction === "rtl"
  }, className, rootClassName, cssVarCls, rootCls, hashId);
  return wrapCSSVar(React4.createElement("div", Object.assign({
    className: classString,
    style
  }, domProps, {
    ref
  }), React4.createElement(GroupContext_default.Provider, {
...
//# sourceMappingURL=chunk-O62PN4KI.js.map
