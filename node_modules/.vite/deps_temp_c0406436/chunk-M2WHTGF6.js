...
import {
  Password_default
} from "./chunk-2DFLJKWP.js";
import {
  Input_default
} from "./chunk-N7ZW5PXI.js";
import {
  initComponentToken,
  initInputToken,
  style_default
} from "./chunk-YODFEFMN.js";
import {
  getMergedStatus
...
var Search = React4.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
  ...
  } = props, restProps = __rest3(props, ["prefixCls", "inputPrefixCls", "className", "size", "suffix", "enterButton", "addonAfter", "loading", "disabled", "onSearch", "onChange", "onCompositionStart", "onCompositionEnd", "variant", "onPressEnter"]);
  const {
    getPrefixCls,
    direction
  } = React4.useContext(ConfigContext);
  const composedRef = React4.useRef(false);
  ...
  const searchIcon = typeof enterButton === "boolean" ? React4.createElement(SearchOutlined_default, null) : null;
  ...
  if (isAntdButton || enterButtonAsElement.type === "button") {
    ...
    button = React4.createElement(button_default, {
      className: btnClassName,
  ...
  const cls = (0, import_classnames4.default)(prefixCls, {
    [`${prefixCls}-rtl`]: direction === "rtl",
    [`${prefixCls}-${size}`]: !!size,
...
//# sourceMappingURL=chunk-M2WHTGF6.js.map
