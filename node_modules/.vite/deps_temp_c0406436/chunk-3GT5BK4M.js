import {
  ...
  init_es as init_es2
} from "./chunk-EHO42P2D.js";
import {
  es_default as es_default3,
  init_es as init_es3
} from "./chunk-LEZJLFYS.js";
import {
  KeyCode_default,
  init_KeyCode
...
var React, _excluded, MenuContext;
...
function useMeasure() {
  return React2.useContext(PathRegisterContext);
}
function useFullPath(eventKey) {
  var parentKeyPath = React2.useContext(PathTrackerContext);
  return React2.useMemo(function() {
    return eventKey !== void 0 ? [].concat(_toConsumableArray(parentKeyPath), [eventKey]) : parentKeyPath;
  }, [parentKeyPath, eventKey]);
}
var React2, EmptyList, PathRegisterContext, PathTrackerContext, PathUserContext;
var init_PathContext = __esm({
  "node_modules/rc-menu/es/context/PathContext.js"() {
    init_toConsumableArray();
    React2 = __toESM(require_react());
    EmptyList = [];
    PathRegisterContext = React2.createContext(null);
    PathTrackerContext = React2.createContext(EmptyList);
    PathUserContext = React2.createContext(null);
  }
});
...
function parseChildren(children, keyPath) {
  return toArray(children).map(function(child, index) {
    if (React3.isValidElement(child)) {
      ...
      return React3.cloneElement(child, cloneProps);
    }
    return child;
  });
}
...
var import_classnames, React4, _excluded2, InternalMenuItemGroup, MenuItemGroup, MenuItemGroup_default;
var init_MenuItemGroup = __esm({
  "node_modules/rc-menu/es/MenuItemGroup.js"() {
    ...
    init_PathContext();
    init_commonUtil();
    _excluded2 = ["className", "title", "eventKey", "children"];
    InternalMenuItemGroup = React4.forwardRef(function(props, ref) {
      var className = props.className, title = props.title, eventKey = props.eventKey, children = props.children, restProps = _objectWithoutProperties(props, _excluded2);
      var _React$useContext = React4.useContext(MenuContext), prefixCls = _React$useContext.prefixCls;
      var groupPrefixCls = "".concat(prefixCls, "-item-group");
      return React4.createElement("li", _extends({
        ref,
        role: "presentation"
      }, restProps, {
      ...
      }, title), React4.createElement("ul", {
        role: "group",
        className: "".concat(groupPrefixCls, "-list")
      }, children));
    });
    MenuItemGroup = React4.forwardRef(function(props, ref) {
      ...
      return React4.createElement(InternalMenuItemGroup, _extends({
        ref
...
function useMenuId(eventKey) {
  var id = React5.useContext(IdContext);
  return getMenuId(id, eventKey);
}
var React5, IdContext;
var init_IdContext = __esm({
  "node_modules/rc-menu/es/context/IdContext.js"() {
    React5 = __toESM(require_react());
    IdContext = React5.createContext(null);
  }
});

// node_modules/rc-menu/es/context/PrivateContext.js
var React6, PrivateContext, PrivateContext_default;
var init_PrivateContext = __esm({
  "node_modules/rc-menu/es/context/PrivateContext.js"() {
    React6 = __toESM(require_react());
    PrivateContext = React6.createContext({});
...
function useAccessibility(mode, activeKey, isRtl, id, containerRef, getKeys, getKeyPath, triggerActiveKey, triggerAccessibilityOpen, originOnKeyDown) {
  var rafRef = React7.useRef();
  var activeRef = React7.useRef();
...
var React7, LEFT, RIGHT, UP, DOWN, ENTER, ESC, HOME, END, ArrowKeys, refreshElements;
...
function useKeyRecords() {
  var _React$useState = React8.useState({}), _React$useState2 = _slicedToArray(_React$useState, 2), internalForceUpdate = _React$useState2[1];
  var key2pathRef = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  var path2keyRef = (0, import_react.useRef)(/* @__PURE__ */ new Map());
  var _React$useState3 = React8.useState([]), _React$useState4 = _slicedToArray(_React$useState3, 2), overflowKeys = _React$useState4[0], setOverflowKeys = _React$useState4[1];
...
var React8, import_react, PATH_SPLIT, getPathStr, getPathKeys, OVERFLOW_KEY;
...
function useMemoCallback(func) {
  var funRef = React9.useRef(func);
  funRef.current = func;
  var callback = React9.useCallback(function() {
    var _funRef$current;
...
var React10, uniquePrefix, internalId;
...
function useActive(eventKey, disabled, onMouseEnter, onMouseLeave) {
  var _React$useContext = React11.useContext(MenuContext), activeKey = _React$useContext.activeKey, onActive = _React$useContext.onActive, onInactive = _React$useContext.onInactive;
  var ret = {
...
function useDirectionStyle(level) {
  var _React$useContext = React12.useContext(MenuContext), mode = _React$useContext.mode, rtl = _React$useContext.rtl, inlineIndent = _React$useContext.inlineIndent;
  if (mode !== "inline") {
    return null;
  }
  var len = level;
...
function Icon(_ref) {
  ...
  if (typeof icon === "function") {
    iconNode = React13.createElement(icon, _objectSpread2({}, props));
...
function MenuItem(props, ref) {
  ...
  return React14.createElement(InternalMenuItem, _extends({}, props, {
    ref
  }));
}
var import_classnames2, React14, _excluded4, _excluded22, _excluded32, LegacyMenuItem, InternalMenuItem, MenuItem_default;
var init_MenuItem = __esm({
  "node_modules/rc-menu/es/MenuItem.js"() {
    ...
    init_Icon();
    init_warnUtil();
    _excluded4 = ["title", "attribute", "elementRef"];
    _excluded22 = ["style", "className", "eventKey", "warnKey", "disabled", "itemIcon", "children", "role", "onMouseEnter", "onMouseLeave", "onClick", "onKeyDown", "onFocus"];
    _excluded32 = ["active"];
    LegacyMenuItem = function(_React$Component) {
      ...
      _createClass(LegacyMenuItem2, [{
        ...
        value: function render() {
          ...
          return React14.createElement(es_default2.Item, _extends({}, attribute, {
            title: typeof title === "string" ? title : void 0
          }, passedProps, {
            ref: elementRef
          }));
    ...
    InternalMenuItem = React14.forwardRef(function(props, ref) {
      ...
      var _React$useContext = React14.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, onItemClick = _React$useContext.onItemClick, contextDisabled = _React$useContext.disabled, overflowDisabled = _React$useContext.overflowDisabled, contextItemIcon = _React$useContext.itemIcon, selectedKeys = _React$useContext.selectedKeys, onActive = _React$useContext.onActive;
      var _React$useContext2 = React14.useContext(PrivateContext_default), _internalRenderMenuItem = _React$useContext2._internalRenderMenuItem;
      var itemCls = "".concat(prefixCls, "-item");
      var legacyMenuItemRef = React14.useRef();
      ...
      var renderNode = React14.createElement(LegacyMenuItem, _extends({
      ...
      }), children, React14.createElement(Icon, {
    ...
    MenuItem_default = React14.forwardRef(MenuItem);
  }
});

// node_modules/rc-menu/es/SubMenu/SubMenuList.js
var React15, import_classnames3, _excluded5, InternalSubMenuList, SubMenuList, SubMenuList_default;
var init_SubMenuList = __esm({
  "node_modules/rc-menu/es/SubMenu/SubMenuList.js"() {
    ...
    InternalSubMenuList = function InternalSubMenuList2(_ref, ref) {
      ...
      var _React$useContext = React15.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, mode = _React$useContext.mode, rtl = _React$useContext.rtl;
      return React15.createElement("ul", _extends({
    ...
    SubMenuList = React15.forwardRef(InternalSubMenuList);
...
var autoAdjustOverflow, placements, placementsRtl;
...
function PopupTrigger(_ref) {
  ...
  var targetMotionRef = React16.useRef(targetMotion);
  if (mode !== "inline") {
  ...
  return React16.createElement(es_default3, {
    prefixCls,
...
var React16, import_classnames4, popupPlacementMap;
...
function InlineSubMenuList(_ref) {
  ...
  var _React$useContext = React17.useContext(MenuContext), prefixCls = _React$useContext.prefixCls, forceSubMenuRender = _React$useContext.forceSubMenuRender, motion = _React$useContext.motion, defaultMotions = _React$useContext.defaultMotions, mode = _React$useContext.mode;
  var sameModeRef = React17.useRef(false);
  sameModeRef.current = mode === fixedMode;
  var _React$useState = React17.useState(!sameModeRef.current), _React$useState2 = _slicedToArray(_React$useState, 2), destroy = _React$useState2[0], setDestroy = _React$useState2[1];
  ...
  return React17.createElement(InheritableContextProvider, {
    mode: fixedMode,
    locked: !sameModeRef.current
  }, React17.createElement(es_default, _extends({
    visible: mergedOpen
  }, mergedMotion, {
    forceRender: forceSubMenuRender,
    removeOnLeave: false,
    ...
    return React17.createElement(SubMenuList_default, {
      id,
...
var React18, import_classnames5, _excluded6, _excluded23, InternalSubMenu, SubMenu, SubMenu_default;
var init_SubMenu = __esm({
  "node_modules/rc-menu/es/SubMenu/index.js"() {
    ...
    init_IdContext();
    init_PrivateContext();
    _excluded6 = ["style", "className", "title", "eventKey", "warnKey", "disabled", "internalPopupClose", "children", "itemIcon", "expandIcon", "popupClassName", "popupOffset", "popupStyle", "onClick", "onMouseEnter", "onMouseLeave", "onTitleClick", "onTitleMouseEnter", "onTitleMouseLeave"];
    _excluded23 = ["active"];
    InternalSubMenu = React18.forwardRef(function(props, ref) {
      ...
      var _React$useContext2 = React18.useContext(PrivateContext_default), _internalRenderSubMenuItem = _React$useContext2._internalRenderSubMenuItem;
      var _React$useContext3 = React18.useContext(PathUserContext), isSubPathKey = _React$useContext3.isSubPathKey;
      var connectedPath = useFullPath();
      var subMenuPrefixCls = "".concat(prefixCls, "-submenu");
      var mergedDisabled = contextDisabled || disabled;
      var elementRef = React18.useRef();
      var popupRef = React18.useRef();
      if (warnKey) {
      ...
      var _React$useState = React18.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), childrenActive = _React$useState2[0], setChildrenActive = _React$useState2[1];
      ...
      var mergedActive = React18.useMemo(function() {
        if (active) {
          return active;
        }
        if (mode !== "inline") {
      ...
      var expandIconNode = React18.useMemo(function() {
        return React18.createElement(Icon, {
        ...
        }, React18.createElement("i", {
          className: "".concat(subMenuPrefixCls, "-arrow")
        }));
      }, [mode, mergedExpandIcon, props, open, subMenuPrefixCls]);
      var titleNode = React18.createElement("div", _extends({
        role: "menuitem",
      ...
      var triggerModeRef = React18.useRef(mode);
      ...
      if (!overflowDisabled) {
        ...
        titleNode = React18.createElement(PopupTrigger, {
          mode: triggerMode,
          ...
          popupOffset,
          popupStyle,
          popup: React18.createElement(
            InheritableContextProvider,
            {
              mode: triggerMode === "horizontal" ? "vertical" : triggerMode
            },
            React18.createElement(SubMenuList_default, {
              id: popupId,
              ref: popupRef
            }, children)
          ),
      ...
      var listNode = React18.createElement(es_default2.Item, _extends({
        ref,
        role: "none"
      }, restProps, {
        component: "li",
      ...
      }), titleNode, !overflowDisabled && React18.createElement(InlineSubMenuList, {
        id: popupId,
        open,
      ...
      return React18.createElement(InheritableContextProvider, {
    ...
    SubMenu = React18.forwardRef(function(props, ref) {
      var eventKey = props.eventKey, children = props.children;
      var connectedKeyPath = useFullPath(eventKey);
      var childList = parseChildren(children, connectedKeyPath);
      var measure = useMeasure();
      ...
      if (measure) {
        ...
        renderNode = React18.createElement(InternalSubMenu, _extends({
          ref
        }, props), childList);
      }
      return React18.createElement(PathTrackerContext.Provider, {
...
function Divider(_ref) {
  ...
  var _React$useContext = React19.useContext(MenuContext), prefixCls = _React$useContext.prefixCls;
  var measure = useMeasure();
  if (measure) {
    return null;
  }
  return React19.createElement("li", {
    role: "separator",
    className: (0, import_classnames6.default)("".concat(prefixCls, "-item-divider"), className),
    style
  });
}
var React19, import_classnames6;
...
function convertItemsToNodes(list, components, prefixCls) {
  ...
  return (list || []).map(function(opt, index) {
    if (opt && _typeof(opt) === "object") {
      var _ref = opt, label = _ref.label, children = _ref.children, key = _ref.key, type = _ref.type, extra = _ref.extra, restProps = _objectWithoutProperties(_ref, _excluded7);
      var mergedKey = key !== null && key !== void 0 ? key : "tmp-".concat(index);
      if (children || type === "group") {
        if (type === "group") {
          return React20.createElement(MergedMenuItemGroup, _extends({
            key: mergedKey
          }, restProps, {
            title: label
          }), convertItemsToNodes(children, components, prefixCls));
        }
        return React20.createElement(MergedSubMenu, _extends({
          key: mergedKey
        }, restProps, {
          title: label
        }), convertItemsToNodes(children, components, prefixCls));
      ...
      if (type === "divider") {
        return React20.createElement(MergedDivider, _extends({
          key: mergedKey
        }, restProps));
      }
      return React20.createElement(MergedMenuItem, _extends({
        key: mergedKey
      }, restProps, {
        extra
      }), label, (!!extra || extra === 0) && React20.createElement("span", {
...
var init_nodeUtil = __esm({
  "node_modules/rc-menu/es/utils/nodeUtil.js"() {
    ...
    init_SubMenu();
    init_commonUtil();
    _excluded7 = ["label", "children", "key", "type", "extra"];
  }
});

// node_modules/rc-menu/es/Menu.js
var import_classnames7, React21, import_react2, import_react_dom, _excluded8, EMPTY_LIST, Menu, Menu_default;
var init_Menu = __esm({
  "node_modules/rc-menu/es/Menu.js"() {
    init_extends();
    init_defineProperty();
    ...
    Menu = React21.forwardRef(function(props, ref) {
      ...
      var _React$useState = React21.useState(false), _React$useState2 = _slicedToArray(_React$useState, 2), mounted = _React$useState2[0], setMounted = _React$useState2[1];
      var containerRef = React21.useRef();
      var uuid = useUUID(id);
      ...
      var _React$useState3 = React21.useState(mergedOpenKeys), _React$useState4 = _slicedToArray(_React$useState3, 2), inlineCacheOpenKeys = _React$useState4[0], setInlineCacheOpenKeys = _React$useState4[1];
      var mountRef = React21.useRef(false);
      var _React$useMemo3 = React21.useMemo(function() {
      ...
      var _React$useState5 = React21.useState(mergedMode), _React$useState6 = _slicedToArray(_React$useState5, 2), internalMode = _React$useState6[0], setInternalMode = _React$useState6[1];
      var _React$useState7 = React21.useState(mergedInlineCollapsed), _React$useState8 = _slicedToArray(_React$useState7, 2), internalInlineCollapsed = _React$useState8[0], setInternalInlineCollapsed = _React$useState8[1];
      ...
      var _React$useState9 = React21.useState(0), _React$useState10 = _slicedToArray(_React$useState9, 2), lastVisibleIndex = _React$useState10[0], setLastVisibleIndex = _React$useState10[1];
      ...
      var registerPathContext = React21.useMemo(function() {
        return {
          registerPath,
          unregisterPath
        };
      }, [registerPath, unregisterPath]);
      var pathUserContext = React21.useMemo(function() {
        return {
          isSubPathKey
        };
      }, [isSubPathKey]);
      ...
      var privateContext = React21.useMemo(function() {
        return {
      ...
      var wrappedChildList = internalMode !== "horizontal" || disabledOverflow ? childList : (
        ...
        childList.map(function(child, index) {
          return (
            ...
            React21.createElement(InheritableContextProvider, {
              key: child.key,
      ...
      var container = React21.createElement(es_default2, _extends({
        id,
        ref: containerRef,
        prefixCls: "".concat(prefixCls, "-overflow"),
        component: "ul",
        itemComponent: MenuItem_default,
        className: (0, import_classnames7.default)(prefixCls, "".concat(prefixCls, "-root"), "".concat(prefixCls, "-").concat(internalMode), className, _defineProperty(_defineProperty({}, "".concat(prefixCls, "-inline-collapsed"), internalInlineCollapsed), "".concat(prefixCls, "-rtl"), isRtl), rootClassName),
        dir: direction,
        style,
        role: "menu",
        tabIndex,
        ...
        renderRawRest: function renderRawRest(omitItems) {
          ...
          return React21.createElement(SubMenu_default, {
      ...
      return React21.createElement(PrivateContext_default.Provider, {
        value: privateContext
      }, React21.createElement(IdContext.Provider, {
        value: uuid
      }, React21.createElement(InheritableContextProvider, {
        prefixCls,
        rootClassName,
      ...
      }, React21.createElement(PathUserContext.Provider, {
        value: pathUserContext
      }, container), React21.createElement("div", {
        style: {
          display: "none"
        },
        "aria-hidden": true
      }, React21.createElement(PathRegisterContext.Provider, {
...
function useAccessibility2(_ref) {
  ...
  var focusMenuRef = React22.useRef(false);
...
var import_react3, Overlay, Overlay_default;
var init_Overlay = __esm({
  "node_modules/rc-dropdown/es/Overlay.js"() {
    init_ref();
    import_react3 = __toESM(require_react());
    Overlay = (0, import_react3.forwardRef)(function(props, ref) {
      var overlay = props.overlay, arrow = props.arrow, prefixCls = props.prefixCls;
      var overlayNode = (0, import_react3.useMemo)(function() {
        var overlayElement;
      ...
      return import_react3.default.createElement(import_react3.default.Fragment, null, arrow && import_react3.default.createElement("div", {
        className: "".concat(prefixCls, "-arrow")
      }), import_react3.default.cloneElement(overlayNode, {
...
var autoAdjustOverflow2, targetOffset, placements2, placements_default;
...
function Dropdown(props, ref) {
  var _children$props;
  var _props$arrow = props.arrow, arrow = _props$arrow === void 0 ? false : _props$arrow, _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? "rc-dropdown" : _props$prefixCls, transitionName = props.transitionName, animation = props.animation, align = props.align, _props$placement = props.placement, placement = _props$placement === void 0 ? "bottomLeft" : _props$placement, _props$placements = props.placements, placements3 = _props$placements === void 0 ? placements_default : _props$placements, getPopupContainer = props.getPopupContainer, showAction = props.showAction, hideAction = props.hideAction, overlayClassName = props.overlayClassName, overlayStyle = props.overlayStyle, visible = props.visible, _props$trigger = props.trigger, trigger = _props$trigger === void 0 ? ["hover"] : _props$trigger, autoFocus = props.autoFocus, overlay = props.overlay, children = props.children, onVisibleChange = props.onVisibleChange, otherProps = _objectWithoutProperties(props, _excluded9);
  var _React$useState = import_react4.default.useState(), _React$useState2 = _slicedToArray(_React$useState, 2), triggerVisible = _React$useState2[0], setTriggerVisible = _React$useState2[1];
  var mergedVisible = "visible" in props ? visible : triggerVisible;
  var triggerRef = import_react4.default.useRef(null);
  var overlayRef = import_react4.default.useRef(null);
  var childRef = import_react4.default.useRef(null);
  import_react4.default.useImperativeHandle(ref, function() {
  ...
  var getMenuElement = function getMenuElement2() {
    return import_react4.default.createElement(Overlay_default, {
      ref: overlayRef,
      overlay,
      prefixCls,
      arrow
  ...
  var childrenNode = import_react4.default.cloneElement(children, {
    className: (0, import_classnames8.default)((_children$props = children.props) === null || _children$props === void 0 ? void 0 : _children$props.className, mergedVisible && getOpenClassName()),
  ...
  return import_react4.default.createElement(es_default3, _extends({
    builtinPlacements: placements3
  }, otherProps, {
    prefixCls,
    ref: triggerRef,
    popupClassName: (0, import_classnames8.default)(overlayClassName, _defineProperty({}, "".concat(prefixCls, "-show-arrow"), arrow)),
...
var import_classnames8, import_react4, _excluded9, Dropdown_default;
var init_Dropdown = __esm({
  "node_modules/rc-dropdown/es/Dropdown.js"() {
    ...
    init_Overlay();
    init_placements2();
    _excluded9 = ["arrow", "prefixCls", "transitionName", "animation", "align", "placement", "placements", "getPopupContainer", "showAction", "hideAction", "overlayClassName", "overlayStyle", "visible", "trigger", "autoFocus", "overlay", "children", "onVisibleChange"];
    Dropdown_default = import_react4.default.forwardRef(Dropdown);
  }
});
...
//# sourceMappingURL=chunk-3GT5BK4M.js.map
