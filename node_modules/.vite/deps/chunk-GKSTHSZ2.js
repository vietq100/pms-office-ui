...
import {
  getMergedStatus,
  getStatusClassNames
} from "./chunk-FCOGSOXM.js";
import {
  useVariants_default
} from "./chunk-4YT2RFPS.js";
import {
  genRoundedArrow,
  getArrowToken
  ...
  return React.useMemo(() => {
    ...
    const filledClassNames = Object.assign(Object.assign({}, mergedClassNames), {
      popup: Object.assign(Object.assign({}, mergedClassNames.popup), {
        root: (0, import_classnames.default)((_a = mergedClassNames.popup) === null || _a === void 0 ? void 0 : _a.root, popupClassName)
      })
    });
...
var prepareComponentToken = (token) => Object.assign(Object.assign(Object.assign(Object.assign({}, initComponentToken(token)), initPanelComponentToken(token)), getArrowToken(token)), {
  presetsWidth: 120,
  presetsMaxWidth: 200,
...
function useIcons2(props, prefixCls) {
  ...
  const mergedAllowClear = React2.useMemo(() => {
    if (allowClear === false) {
      return false;
    }
...
var SuffixIcon = ({
  ...
  if (suffixIcon === true || suffixIcon === void 0) {
    return import_react.default.createElement(import_react.default.Fragment, null, picker === TIME ? import_react.default.createElement(ClockCircleOutlined_default, null) : import_react.default.createElement(CalendarOutlined_default, null), hasFeedback && feedbackIcon);
  }
  return suffixIcon;
};
...
var PickerButton = (props) => React4.createElement(button_default, Object.assign({
  size: "small",
  type: "primary"
}, props));
...
function useComponents(components) {
  return (0, import_react2.useMemo)(() => Object.assign({
...
var generateRangePicker = (generateConfig2) => {
  const RangePicker = (0, import_react3.forwardRef)((props, ref) => {
    var _a;
    const {
    ...
    const formItemContext = (0, import_react3.useContext)(FormItemInputContext);
    const {
      hasFeedback,
      status: contextStatus,
      feedbackIcon
    } = formItemContext;
    const mergedSuffixIcon = React5.createElement(SuffixIcon_default, {
      picker,
      hasFeedback,
      feedbackIcon,
      suffixIcon
    ...
    return wrapCSSVar(React5.createElement(ContextIsolator_default, {
      space: true
    }, React5.createElement(RangePicker_default, Object.assign({
      separator: React5.createElement("span", {
        "aria-label": "to",
        className: `${prefixCls}-separator`
      }, React5.createElement(SwapRightOutlined_default, null)),
      disabled: mergedDisabled,
      ref: innerRef,
      placement,
      placeholder: getRangePlaceholder(locale, picker, placeholder),
      suffixIcon: mergedSuffixIcon,
      prevIcon: React5.createElement("span", {
        className: `${prefixCls}-prev-icon`
      }),
      nextIcon: React5.createElement("span", {
        className: `${prefixCls}-next-icon`
      }),
      superPrevIcon: React5.createElement("span", {
        className: `${prefixCls}-super-prev-icon`
      }),
      superNextIcon: React5.createElement("span", {
      ...
      direction,
      classNames: {
        popup: (0, import_classnames2.default)(hashId, cssVarCls, rootCls, rootClassName, mergedClassNames.popup.root)
      },
      styles: {
...
var generatePicker = (generateConfig2) => {
  const getPicker = (picker, displayName) => {
    ...
    const Picker = (0, import_react4.forwardRef)((props, ref) => {
      var _a;
      const {
        prefixCls: customizePrefixCls,
        ...
        classNames,
        suffixIcon
      } = props, restProps = __rest2(props, ["prefixCls", "getPopupContainer", "components", "style", "className", "rootClassName", "size", "bordered", "placement", "placeholder", "popupStyle", "popupClassName", "dropdownClassName", "disabled", "status", "variant", "onCalendarChange", "styles", "classNames", "suffixIcon"]);
      const {
        getPrefixCls,
        direction,
        getPopupContainer,
      ...
      const [mergedClassNames, mergedStyles] = useMergedPickerSemantic_default(consumerName, classNames, styles, popupClassName || dropdownClassName, popupStyle);
      ...
      const mergedDisabled = customDisabled !== null && customDisabled !== void 0 ? customDisabled : disabled;
      const formItemContext = (0, import_react4.useContext)(FormItemInputContext);
      const {
        hasFeedback,
        status: contextStatus,
        feedbackIcon
      } = formItemContext;
      const mergedSuffixIcon = React6.createElement(SuffixIcon_default, {
        picker: mergedPicker,
        hasFeedback,
        feedbackIcon,
        suffixIcon
      ...
      const locale = Object.assign(Object.assign({}, contextLocale), props.locale);
      const [zIndex] = useZIndex("DatePicker", (_a = mergedStyles.popup.root) === null || _a === void 0 ? void 0 : _a.zIndex);
      return wrapCSSVar(React6.createElement(ContextIsolator_default, {
        space: true
      }, React6.createElement(es_default, Object.assign({
        ref: innerRef,
        placeholder: getPlaceholder(locale, mergedPicker, placeholder),
        suffixIcon: mergedSuffixIcon,
        placement,
        prevIcon: React6.createElement("span", {
          className: `${prefixCls}-prev-icon`
        }),
        nextIcon: React6.createElement("span", {
          className: `${prefixCls}-next-icon`
        }),
        superPrevIcon: React6.createElement("span", {
          className: `${prefixCls}-super-prev-icon`
        }),
        superNextIcon: React6.createElement("span", {
          className: `${prefixCls}-super-next-icon`
        }),
        transitionName: `${rootPrefixCls}-slide-up`,
        picker,
        ...
        disabled: mergedDisabled,
        classNames: {
          popup: (0, import_classnames3.default)(hashId, cssVarCls, rootCls, rootClassName, mergedClassNames.popup.root)
        },
        styles: {
          popup: Object.assign(Object.assign({}, mergedStyles.popup.root), {
            zIndex
...
var generatePicker2 = (generateConfig2) => {
  ...
  const RangePicker = generateRangePicker_default(generateConfig2);
...
var PurePanel = PurePanel_default(DatePicker, "popupAlign", void 0, "picker");
...
//# sourceMappingURL=chunk-GKSTHSZ2.js.map
