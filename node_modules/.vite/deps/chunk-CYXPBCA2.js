...
var React, import_classnames, _excluded, UNDEFINED, Item, Item_default;
var init_Item = __esm({
  "node_modules/rc-overflow/es/Item.js"() {
    init_extends();
    init_objectSpread2();
    ...
    init_es();
    _excluded = ["prefixCls", "invalidate", "item", "renderItem", "responsive", "responsiveDisabled", "registerSize", "itemKey", "className", "style", "children", "display", "order", "component"];
    UNDEFINED = void 0;
    Item = React.forwardRef(InternalItem);
...
var import_react, OverflowContext;
var init_context = __esm({
  "node_modules/rc-overflow/es/context.js"() {
    import_react = __toESM(require_react());
    OverflowContext = import_react.default.createContext(null);
  }
});

// node_modules/rc-overflow/es/RawItem.js
var React4, import_classnames2, _excluded2, _excluded22, _excluded3, InternalRawItem, RawItem, RawItem_default;
var init_RawItem = __esm({
  "node_modules/rc-overflow/es/RawItem.js"() {
    ...
    RawItem = React4.forwardRef(InternalRawItem);
...
function Overflow(props, ref) {
  var _props$prefixCls = props.prefixCls, prefixCls = _props$prefixCls === void 0 ? "rc-overflow" : _props$prefixCls, _props$data = props.data, data = _props$data === void 0 ? [] : _props$data, renderItem = props.renderItem, renderRawItem = props.renderRawItem, itemKey = props.itemKey, _props$itemWidth = props.itemWidth, itemWidth = _props$itemWidth === void 0 ? 10 : _props$itemWidth, ssr = props.ssr, style = props.style, className = props.className, maxCount = props.maxCount, renderRest = props.renderRest, renderRawRest = props.renderRawRest, prefix = props.prefix, suffix = props.suffix, _props$component = props.component, Component = _props$component === void 0 ? "div" : _props$component, itemComponent = props.itemComponent, onVisibleChange = props.onVisibleChange, restProps = _objectWithoutProperties(props, _excluded4);
  ...
  var overflowNode = React5.createElement(Component, _extends({
    ...
    style,
    ref
  }, restProps), prefix && React5.createElement(Item_default, _extends({}, itemSharedProps, {
    ...
    display: true
  }), prefix), mergedData.map(internalRenderItemNode), showRest ? restNode : null, suffix && React5.createElement(Item_default, _extends({}, itemSharedProps, {
    responsive: isResponsive,
    responsiveDisabled: !shouldResponsive,
...
var React5, import_react2, import_classnames3, _excluded4, RESPONSIVE, INVALIDATE, ForwardOverflow, Overflow_default;
var init_Overflow = __esm({
  "node_modules/rc-overflow/es/Overflow.js"() {
    ...
    init_context();
    init_context();
    _excluded4 = ["prefixCls", "data", "renderItem", "renderRawItem", "itemKey", "itemWidth", "ssr", "style", "className", "maxCount", "renderRest", "renderRawRest", "prefix", "suffix", "component", "itemComponent", "onVisibleChange"];
    RESPONSIVE = "responsive";
    INVALIDATE = "invalidate";
    ForwardOverflow = React5.forwardRef(Overflow);
...
//# sourceMappingURL=chunk-CYXPBCA2.js.map
