...
import {
  AggregationColor,
  generateColor
} from "./chunk-QQGOA76A.js";
import {
  Color,
  ColorBlock_default,
  init_es as init_es3
} from "./chunk-G35KHRBR.js";
import {
  cloneElement,
  isFragment
...
var _ButtonVariantTypes = ["outlined", "dashed", "solid", "filled", "text", "link"];
...
init_es4();
var CollapsePanel = React5.forwardRef((props, ref) => {
  if (true) {
...
// node_modules/antd/es/collapse/Collapse.js
var Collapse = React6.forwardRef((props, ref) => {
  const {
    getPrefixCls,
    direction,
  ...
  const renderExpandIcon = React6.useCallback((panelProps = {}) => {
    ...
    return cloneElement(icon, () => {
      var _a;
      return {
        className: (0, import_classnames5.default)((_a = icon.props) === null || _a === void 0 ? void 0 : _a.className, `${prefixCls}-arrow`)
      };
    });
  ...
  const openMotion = React6.useMemo(() => Object.assign(Object.assign({}, motion_default(rootPrefixCls)), {
    motionAppear: false,
...
var ColorPresets = ({
  ...
  const activeKeys = (0, import_react4.useMemo)(() => presetsValue.reduce((acc, preset, index) => {
    const {
      defaultOpen = true
    } = preset;
    if (defaultOpen) {
  ...
  const items = presetsValue.map((preset, index) => {
    ...
    return {
      ...
      label: import_react4.default.createElement("div", {
        className: `${colorPresetsPrefixCls}-label`
      }, preset === null || preset === void 0 ? void 0 : preset.label),
      children: import_react4.default.createElement("div", {
        className: `${colorPresetsPrefixCls}-items`
      }, Array.isArray(preset === null || preset === void 0 ? void 0 : preset.colors) && ((_a = preset.colors) === null || _a === void 0 ? void 0 : _a.length) > 0 ? preset.colors.map((presetColor, index2) => import_react4.default.createElement(
        ColorBlock_default,
        {
          ...
          prefixCls,
          className: (0, import_classnames6.default)(`${colorPresetsPrefixCls}-color`, {
  ...
  }, import_react4.default.createElement(collapse_default2, {
...
var InternalCompoundedButton = import_react5.default.forwardRef((props, ref) => {
  ...
  const [mergedColor, mergedVariant] = (0, import_react5.useMemo)(() => {
    if (color && variant) {
  ...
  const needInserted = import_react5.Children.count(children) === 1 && !icon && !isUnBorderedButtonVariant(mergedVariant);
  ...
  const handleClick = import_react5.default.useCallback((e) => {
    var _a2;
  ...
  const iconClasses = (0, import_classnames7.default)(customClassNames === null || customClassNames === void 0 ? void 0 : customClassNames.icon, contextClassNames.icon);
  const iconStyle = Object.assign(Object.assign({}, (styles === null || styles === void 0 ? void 0 : styles.icon) || {}), contextStyles.icon || {});
  const iconWrapperElement = (child) => import_react5.default.createElement(IconWrapper_default, {
    prefixCls,
    className: iconClasses,
    style: iconStyle
  }, child);
  const defaultLoadingIconElement = () => import_react5.default.createElement(DefaultLoadingIcon_default, {
    existIcon: !!icon,
    prefixCls,
  ...
  let buttonNode = import_react5.default.createElement("button", Object.assign({}, rest, {
    ...
    ref: mergedRef
  }), iconNode, kids, compactItemClassnames && import_react5.default.createElement(compact_default, {
    prefixCls
  }));
...
//# sourceMappingURL=chunk-F4H7BHNH.js.map
