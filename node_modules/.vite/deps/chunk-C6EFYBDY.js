...
var style_default2 = genStyleHooks("Popover", (token) => {
  const {
    colorBgElevated,
    colorText
  } = token;
  ...
  return [genBaseStyle2(popoverToken), genColorStyle(popoverToken), initZoomMotion(popoverToken, "zoom-big")];
...
var Overlay = ({
  ...
  return React3.createElement(React3.Fragment, null, title && React3.createElement("div", {
    className: `${prefixCls}-title`
  }, title), content && React3.createElement("div", {
...
var RawPurePanel = (props) => {
  ...
  const cls = (0, import_classnames2.default)(hashId, prefixCls, `${prefixCls}-pure`, `${prefixCls}-placement-${placement}`, className);
  return React3.createElement("div", {
    ...
    className: hashId,
    prefixCls
  }), children || React3.createElement(Overlay, {
    prefixCls,
    title: titleNode,
    content: contentNode
  })));
...
var PurePanel = (props) => {
  const {
    prefixCls: customizePrefixCls,
    className
  } = props, restProps = __rest2(props, ["prefixCls", "className"]);
  const {
    getPrefixCls
  } = React3.useContext(ConfigContext);
  const prefixCls = getPrefixCls("popover", customizePrefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default2(prefixCls);
  return wrapCSSVar(React3.createElement(RawPurePanel, Object.assign({}, restProps, {
    prefixCls,
    hashId,
    className: (0, import_classnames2.default)(className, cssVarCls)
  })));
};
...
var InternalPopover = React4.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    title,
  ...
  } = props, otherProps = __rest3(props, ["prefixCls", "title", "content", "overlayClassName", "placement", "trigger", "children", "mouseEnterDelay", "mouseLeaveDelay", "onOpenChange", "overlayStyle", "styles", "classNames"]);
  const {
    getPrefixCls,
  ...
  const rootClassNames = (0, import_classnames3.default)(overlayClassName, hashId, cssVarCls, contextClassName, contextClassNames.root, popoverClassNames === null || popoverClassNames === void 0 ? void 0 : popoverClassNames.root);
  const bodyClassNames = (0, import_classnames3.default)(contextClassNames.body, popoverClassNames === null || popoverClassNames === void 0 ? void 0 : popoverClassNames.body);
  ...
  const titleNode = getRenderPropValue(title);
  const contentNode = getRenderPropValue(content);
  return wrapCSSVar(React4.createElement(tooltip_default, Object.assign({
    placement,
    trigger,
    mouseEnterDelay,
    mouseLeaveDelay
    ...
    overlay: titleNode || contentNode ? React4.createElement(Overlay, {
      prefixCls,
      title: titleNode,
      content: contentNode
    }) : null,
...
var AvatarContextProvider = (props) => {
  const {
    size,
    shape
  } = React5.useContext(AvatarContext_default);
  const avatarContextValue = React5.useMemo(() => ({
    size: props.size || size,
    shape: props.shape || shape
  }), [props.size, props.shape, size, shape]);
  return React5.createElement(AvatarContext_default.Provider, {
...
var AvatarGroup = (props) => {
  ...
  const rootCls = useCSSVarCls_default(prefixCls);
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls, rootCls);
  const cls = (0, import_classnames4.default)(groupPrefixCls, {
  ...
  if (mergeCount && mergeCount < numOfChildren) {
    ...
    const mergeProps = Object.assign(Object.assign({
      ...
      classNames: {
        root: (0, import_classnames4.default)(`${groupPrefixCls}-popover`, (_d = (_c = max === null || max === void 0 ? void 0 : max.popover) === null || _c === void 0 ? void 0 : _c.classNames) === null || _d === void 0 ? void 0 : _d.root)
      },
      placement: mergePopoverPlacement,
      trigger: mergePopoverTrigger
    });
    childrenShow.push(React5.createElement(popover_default, Object.assign({
      key: "avatar-popover-key",
      destroyOnHidden: true
    }, mergeProps), React5.createElement(Avatar_default, {
      style: mergeStyle
    }, `+${numOfChildren - mergeCount}`)));
    return wrapCSSVar(React5.createElement(AvatarContextProvider, {
      shape,
      size
...
//# sourceMappingURL=chunk-C6EFYBDY.js.map
