...
var Col = React.forwardRef((props, ref) => {
  ...
  const {
    gutter,
    wrap
  } = React.useContext(RowContext_default);
  const {
...
function useMergedPropByScreen(oriProp, screen) {
  const [prop, setProp] = React2.useState(typeof oriProp === "string" ? oriProp : "");
...
var Row = React2.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    justify,
    align,
  ...
  const rowContext = React2.useMemo(() => ({
    gutter: [gutterH, gutterV],
    wrap
  }), [gutterH, gutterV, wrap]);
  return wrapCSSVar(React2.createElement(RowContext_default.Provider, {
    value: rowContext
...
//# sourceMappingURL=chunk-JF7OZ7HX.js.map
