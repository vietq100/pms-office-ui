...
var Input = (0, import_react3.forwardRef)((props, ref) => {
  const {
    ...
    _skipAddonWarning
  } = props, rest = __rest(props, ["prefixCls", "bordered", "status", "size", "disabled", "onBlur", "onFocus", "suffix", "allowClear", "addonAfter", "addonBefore", "className", "style", "styles", "rootClassName", "onChange", "classNames", "variant", "_skipAddonWarning"]);
  if (true) {
    const {
      deprecated
    } = devUseWarning("Input");
  ...
  return wrapSharedCSSVar(wrapCSSVar(import_react3.default.createElement(es_default, Object.assign({
    ...
    addonBefore: addonBefore && import_react3.default.createElement(ContextIsolator_default, {
      form: true,
      space: true
    }, addonBefore),
    addonAfter: addonAfter && import_react3.default.createElement(ContextIsolator_default, {
      form: true,
      space: true
    }, addonAfter),
    classNames: Object.assign(Object.assign(Object.assign({}, classNames), contextClassNames), {
      ...
      variant: (0, import_classnames.default)({
      ...
      wrapper: (0, import_classnames.default)({
...
//# sourceMappingURL=chunk-ROKTVW4L.js.map
