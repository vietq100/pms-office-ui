...
var require_style2 = __commonJS({
  "node_modules/antd/lib/badge/style/index.js"(exports) {
    "use strict";
...
// node_modules/antd/lib/badge/style/ribbon.js
var require_ribbon = __commonJS({
  "node_modules/antd/lib/badge/style/ribbon.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_Ribbon = __commonJS({
  "node_modules/antd/lib/badge/Ribbon.js"(exports) {
    "use strict";
    "use client";
    ...
    var _ribbon = _interopRequireDefault(require_ribbon());
    var Ribbon = (props) => {
      const {
        className,
...
var require_SingleNumber = __commonJS({
  "node_modules/antd/lib/badge/SingleNumber.js"(exports) {
    "use strict";
    "use client";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    ...
    var SingleNumber = (props) => {
      ...
      if (prevValue === value || Number.isNaN(value) || Number.isNaN(prevValue)) {
        unitNodes = [React.createElement(UnitNumber, Object.assign({}, props, {
          key: value,
          current: true
        }))];
        offsetStyle = {
        ...
        unitNodes = cutUnitNumberList.map((n, index) => {
          ...
          return React.createElement(UnitNumber, Object.assign({}, props, {
            key: n,
            value: singleUnit,
...
var require_ScrollNumber = __commonJS({
  "node_modules/antd/lib/badge/ScrollNumber.js"(exports) {
    "use strict";
    "use client";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    ...
    var _configProvider = require_config_provider();
    var _SingleNumber = _interopRequireDefault(require_SingleNumber());
    ...
    var ScrollNumber = React.forwardRef((props, ref) => {
      const {
        prefixCls: customizePrefixCls,
        count,
        className,
      ...
      if (count && Number(count) % 1 === 0) {
        ...
        numberNodes = React.createElement("bdi", null, numberList.map((num, i) => React.createElement(_SingleNumber.default, {
          prefixCls,
          count: Number(count),
          value: num,
      ...
      return React.createElement(Component, Object.assign({}, newProps, {
        ref
      }), numberNodes);
    });
...
var require_badge = __commonJS({
  "node_modules/antd/lib/badge/index.js"(exports) {
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _configProvider = require_config_provider();
    var _Ribbon = _interopRequireDefault(require_Ribbon());
    var _ScrollNumber = _interopRequireDefault(require_ScrollNumber());
    ...
    var InternalBadge = React.forwardRef((props, ref) => {
      var _a, _b, _c, _d, _e;
      const {
        prefixCls: customizePrefixCls,
      ...
      const statusTextNode = !showStatusTextNode ? null : React.createElement("span", {
        className: `${prefixCls}-status-text`
      }, text);
      const displayNode = !livingCount || typeof livingCount !== "object" ? void 0 : (0, _reactNode.cloneElement)(livingCount, (oriProps) => ({
      ...
      if (!children && hasStatus && (text || hasStatusValue || !ignoreCount)) {
        ...
        }), showStatusTextNode && React.createElement("span", {
          style: {
      ...
      return wrapCSSVar(React.createElement("span", Object.assign({
        ref
      }, restProps, {
        className: badgeClassName,
      ...
      }), children, React.createElement(_rcMotion.default, {
        visible: !isHidden,
        ...
        const scrollNumberCls = (0, _classnames.default)(classNames === null || classNames === void 0 ? void 0 : classNames.indicator, (_a2 = badge === null || badge === void 0 ? void 0 : badge.classNames) === null || _a2 === void 0 ? void 0 : _a2.indicator, {
          [`${prefixCls}-dot`]: isDot,
        ...
        return React.createElement(_ScrollNumber.default, {
...
//# sourceMappingURL=antd_lib_badge.js.map
