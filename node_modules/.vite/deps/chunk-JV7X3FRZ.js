...
} from "./chunk-5KF7C5XZ.js";
import {
  isStyleSupport
} from "./chunk-ZQ33OGBI.js";
import {
  TextArea_default
} from "./chunk-KRFCSXZO.js";
import {
  tooltip_default
...
var style_default = genStyleHooks("Typography", genTypographyStyle, prepareComponentToken);
...
var Editable = (props) => {
  const {
    ...
    onEnd,
    component,
    enterIcon = React.createElement(EnterOutlined_default, null)
  } = props;
  ...
  const textAreaClassName = (0, import_classnames.default)(prefixCls, `${prefixCls}-edit-content`, {
  ...
  return wrapCSSVar(React.createElement("div", {
    ...
    style
  }, React.createElement(TextArea_default, {
    ref,
    maxLength,
    value: current,
    onChange,
...
var useCopyClick = ({
  ...
  const [copyLoading, setCopyLoading] = React2.useState(false);
  const copyIdRef = React2.useRef(null);
  const cleanCopyId = () => {
...
var useTooltipProps = (tooltip, editConfigText, children) => (0, import_react2.useMemo)(() => {
  if (tooltip === true) {
    return {
      title: editConfigText !== null && editConfigText !== void 0 ? editConfigText : children
    };
  }
  if ((0, import_react2.isValidElement)(tooltip)) {
    return {
      title: tooltip
    };
  }
...
var Typography = React4.forwardRef((props, ref) => {
  const {
  ...
  const [wrapCSSVar, hashId, cssVarCls] = style_default(prefixCls);
  const componentClassName = (0, import_classnames2.default)(prefixCls, contextClassName, {
    [`${prefixCls}-rtl`]: direction === "rtl"
  }, className, rootClassName, hashId, cssVarCls);
  const mergedStyle = Object.assign(Object.assign({}, contextStyle), style);
  return wrapCSSVar(
    // @ts-expect-error: Expression produces a union type that is too complex to represent.
    React4.createElement(Component, Object.assign({
...
var CopyBtn = ({
  ...
  return React5.createElement(tooltip_default, {
    title: copyTitle
  }, React5.createElement("button", {
    type: "button",
    className: (0, import_classnames3.default)(`${prefixCls}-copy`, {
    ...
    "aria-label": ariaLabel,
    tabIndex
  }, copied ? getNode(iconNodes[1], React5.createElement(CheckOutlined_default, null), true) : getNode(iconNodes[0], btnLoading ? React5.createElement(LoadingOutlined_default, null) : React5.createElement(CopyOutlined_default, null), true)));
};
...
init_toArray();
init_useLayoutEffect();
var MeasureText = React6.forwardRef(({
  style,
  children
}, ref) => {
  const spanRef = React6.useRef(null);
...
function EllipsisMeasure(props) {
  ...
  const nodeList = React6.useMemo(() => toArray(text), [text]);
  const nodeLen = React6.useMemo(() => getNodesLen(nodeList), [text]);
  const fullContent = React6.useMemo(() => children(nodeList, false), [text]);
  const [ellipsisCutIndex, setEllipsisCutIndex] = React6.useState(null);
  const cutMidRef = React6.useRef(null);
  const measureWhiteSpaceRef = React6.useRef(null);
  const needEllipsisRef = React6.useRef(null);
  const descRowsEllipsisRef = React6.useRef(null);
  const symbolRowEllipsisRef = React6.useRef(null);
  const [canEllipsis, setCanEllipsis] = React6.useState(false);
  const [needEllipsis, setNeedEllipsis] = React6.useState(STATUS_MEASURE_NONE);
  const [ellipsisHeight, setEllipsisHeight] = React6.useState(0);
  const [parentWhiteSpace, setParentWhiteSpace] = React6.useState(null);
  useLayoutEffect_default(() => {
  ...
  const finalContent = React6.useMemo(() => {
    if (!enableMeasure) {
  ...
  return React6.createElement(React6.Fragment, null, finalContent, needEllipsis === STATUS_MEASURE_START && React6.createElement(React6.Fragment, null, React6.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
      WebkitLineClamp: rows
    }),
    ref: needEllipsisRef
  }, fullContent), React6.createElement(MeasureText, {
    style: Object.assign(Object.assign(Object.assign({}, measureStyle), lineClipStyle), {
  ...
  }, children([], true))), needEllipsis === STATUS_MEASURE_NEED_ELLIPSIS && ellipsisCutIndex && ellipsisCutIndex[0] !== ellipsisCutIndex[1] && React6.createElement(MeasureText, {
    style: Object.assign(Object.assign({}, measureStyle), {
      top: 400
    }),
    ref: cutMidRef
  }, children(sliceNodes(nodeList, cutMidIndex), true)), needEllipsis === STATUS_MEASURE_PREPARE && React6.createElement("span", {
    style: {
      whiteSpace: "inherit"
    },
...
var EllipsisTooltip = ({
  ...
  return React7.createElement(tooltip_default, Object.assign({
...
function wrapperDecorations({
  ...
  function wrap(tag, needed) {
    ...
    currentContent = React8.createElement(tag, {}, currentContent);
  }
  wrap("strong", strong);
  wrap("u", underline);
  wrap("del", del);
...
var Base = React8.forwardRef((props, ref) => {
  var _a;
  const {
    prefixCls: customizePrefixCls,
    className,
    ...
    component,
    title
  } = props, restProps = __rest2(props, ["prefixCls", "className", "style", "type", "disabled", "children", "ellipsis", "editable", "copyable", "component", "title"]);
  const {
    getPrefixCls,
    direction
  } = React8.useContext(ConfigContext);
  const [textLocale] = useLocale_default("Text");
  const typographyRef = React8.useRef(null);
  const editIconRef = React8.useRef(null);
  const prefixCls = getPrefixCls("typography", customizePrefixCls);
  ...
  const [isLineClampSupport, setIsLineClampSupport] = React8.useState(false);
  const [isTextOverflowSupport, setIsTextOverflowSupport] = React8.useState(false);
  const [isJsEllipsis, setIsJsEllipsis] = React8.useState(false);
  const [isNativeEllipsis, setIsNativeEllipsis] = React8.useState(false);
  const [isNativeVisible, setIsNativeVisible] = React8.useState(true);
  ...
  const needMeasureEllipsis = React8.useMemo(() => (
    // Disable ellipsis
  ...
  const [cssEllipsis, setCssEllipsis] = React8.useState(mergedEnableEllipsis);
  const canUseCssEllipsis = React8.useMemo(() => {
  ...
  const [ellipsisWidth, setEllipsisWidth] = React8.useState(0);
  const onResize = ({
    offsetWidth
  }) => {
  ...
  const topAriaLabel = React8.useMemo(() => {
  ...
  if (editing) {
    return React8.createElement(Editable_default, {
  ...
  const renderExpand = () => {
    ...
    return expandable ? React8.createElement("button", {
      type: "button",
      key: "expand",
  ...
  const renderEdit = () => {
    ...
    return triggerType.includes("icon") ? React8.createElement(tooltip_default, {
      key: "edit",
      ...
      "aria-label": ariaLabel,
      tabIndex
    }, icon || React8.createElement(EditOutlined_default, {
      role: "button"
    }))) : null;
  };
  const renderCopy = () => {
    ...
    return React8.createElement(CopyBtn_default, Object.assign({
      key: "copy"
    }, copyConfig, {
      prefixCls,
      copied,
  ...
  const renderEllipsis = (canEllipsis) => [canEllipsis && !expanded && React8.createElement("span", {
    "aria-hidden": true,
    key: "ellipsis"
  ...
  return React8.createElement(es_default, {
  ...
  }, (resizeRef) => React8.createElement(EllipsisTooltip_default, {
    tooltipProps,
    enableEllipsis: mergedEnableEllipsis,
    isEllipsis: isMergedEllipsis
  }, React8.createElement(Typography_default, Object.assign({
    ...
    title
  }, textProps), React8.createElement(EllipsisMeasure, {
  ...
  }, (node, canEllipsis) => wrapperDecorations(props, React8.createElement(React8.Fragment, null, node.length > 0 && canEllipsis && !expanded && topAriaLabel ? React8.createElement("span", {
    key: "show-content",
    "aria-hidden": true
...
var Paragraph = React9.forwardRef((props, ref) => {
  const {
    children
  } = props, restProps = __rest3(props, ["children"]);
  return React9.createElement(Base_default, Object.assign({
    ref
  }, restProps, {
    component: "div"
  }), children);
...
//# sourceMappingURL=chunk-JV7X3FRZ.js.map
