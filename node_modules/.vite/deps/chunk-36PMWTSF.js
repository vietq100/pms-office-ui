...
function registerTheme(globalPrefixCls2, theme) {
  ...
  if (canUseDom()) {
    ...
    true ? warning_default(false, "ConfigProvider", "SSR do not support dynamic theme with css variables.") : void 0;
  }
}
...
function useConfig() {
  const componentDisabled = (0, import_react2.useContext)(DisabledContext_default);
  const componentSize = (0, import_react2.useContext)(SizeContext_default);
  return {
    componentDisabled,
    componentSize
  };
...
var fullClone = Object.assign({}, React3);
var {
  useId
} = fullClone;
var useEmptyId = () => "";
...
init_es4();
var MotionCacheContext = React4.createContext(true);
if (true) {
  MotionCacheContext.displayName = "MotionCacheContext";
}
function MotionWrapper(props) {
  const parentMotion = React4.useContext(MotionCacheContext);
  const {
    children
  } = props;
  ...
  const needWrapMotionProviderRef = React4.useRef(false);
  needWrapMotionProviderRef.current || (needWrapMotionProviderRef.current = parentMotion !== motion);
  if (needWrapMotionProviderRef.current) {
    return React4.createElement(MotionCacheContext.Provider, {
      value: motion
    }, React4.createElement(MotionProvider, {
      motion
    }, children));
  }
  return children;
...
var warnContext = true ? (componentName) => {
  true ? warning_default(!existThemeConfig, componentName, `Static function can not consume context like dynamic theme. Please use 'App' component instead.`) : void 0;
} : (
...
var setGlobalConfig = (props) => {
  ...
  if (theme) {
    if (isLegacyTheme(theme)) {
      true ? warning_default(false, "ConfigProvider", "`config` of css variable theme is not work in v5. Please use new `theme` config instead.") : void 0;
...
var ProviderChildren = (props) => {
  ...
  const getPrefixCls = React6.useCallback((suffixCls, customizePrefixCls) => {
    const {
      prefixCls
    } = props;
    if (customizePrefixCls) {
  ...
  const {
    layer
  } = React6.useContext(StyleContext_default);
  const memoIconContextValue = React6.useMemo(() => ({
    prefixCls: iconPrefixCls,
    csp,
    layer: layer ? "antd" : void 0
  }), [iconPrefixCls, csp, layer]);
  let childNode = React6.createElement(React6.Fragment, null, React6.createElement(PropWarning_default, {
    dropdownMatchSelectWidth
  }), children);
  const validateMessages = React6.useMemo(() => {
    var _a, _b, _c, _d;
  ...
  if (Object.keys(validateMessages).length > 0) {
    childNode = React6.createElement(validateMessagesContext_default.Provider, {
      value: validateMessages
    }, childNode);
  }
  if (locale5) {
    childNode = React6.createElement(locale_default, {
      locale: locale5,
      _ANT_MARK__: ANT_MARK
    }, childNode);
  }
  if (iconPrefixCls || csp) {
    childNode = React6.createElement(Context_default.Provider, {
      value: memoIconContextValue
    }, childNode);
  }
  if (componentSize) {
    childNode = React6.createElement(SizeContextProvider, {
      size: componentSize
    }, childNode);
  }
  childNode = React6.createElement(MotionWrapper, null, childNode);
  const memoTheme = React6.useMemo(() => {
  ...
  if (theme) {
    childNode = React6.createElement(DesignTokenContext.Provider, {
      value: memoTheme
    }, childNode);
  }
  if (memoedConfig.warning) {
    childNode = React6.createElement(WarningContext.Provider, {
      value: memoedConfig.warning
    }, childNode);
  }
  if (componentDisabled !== void 0) {
    childNode = React6.createElement(DisabledContextProvider, {
      disabled: componentDisabled
    }, childNode);
  }
  return React6.createElement(ConfigContext.Provider, {
    value: memoedConfig
  }, childNode);
};
var ConfigProvider = (props) => {
  const context = React6.useContext(ConfigContext);
  const antLocale = React6.useContext(context_default);
  return React6.createElement(ProviderChildren, Object.assign({
...
Object.defineProperty(ConfigProvider, "SizeContext", {
  get: () => {
    true ? warning_default(false, "ConfigProvider", "ConfigProvider.SizeContext is deprecated. Please use `ConfigProvider.useConfig().componentSize` instead.") : void 0;
...
//# sourceMappingURL=chunk-36PMWTSF.js.map
